...
zenNotebook.filter("object2Array", function () {
    ...
    var app_nav = [{title: "Theme", action: "theme", "class": "fa fa-adjust", sub: "body"}, {
        title: "Settings",
        action: "settings",
        "class": "fa fa-gears",
        sub: "foot"
    ...
    return {
        restrict: "A", link: function (scope, element) {
            ...
            window.setTimeout(function () {
                ...
                scope.$apply(factory.onWrite(element.html())), 0 == $rootScope.mute && $injector.get("themeFactory").themeSound(event)
