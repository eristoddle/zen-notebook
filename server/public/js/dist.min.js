...
zenNotebook.filter("object2Array", function () {
    ...
    $scope.themes = {
        ...
        ngDialog.open({template: "partials/dialog/" + message.action + ".html"}), $scope.expr = function (locals) {
    ...
    $scope.left = {}, $scope.$on("toggleLeft", function () {
        $scope.left.partial = "partials/sidebar/" + $rootScope.active_component + ".html", $scope.leftChangeClass = !$scope.leftChangeClass, $scope.expr = function (locals) {
            menuFactory.publishClick(locals)
        }
    })
