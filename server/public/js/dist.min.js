!function (U, V, u) {
    ...
    function z(b) {
        return function () {
            var c, a = arguments[0];
            for (c = "[" + (b ? b + ":" : "") + a + "] http://errors.angularjs.org/1.3.4/" + (b ? b + "/" : "") + a, a = 1; a < arguments.length; a++) {
                c = c + (1 == a ? "?" : "&") + "p" + (a - 1) + "=";
    ...
    function Ra(b) {
        ...
        var a = b.length;
        return b.nodeType === na && a ? !0 : I(b) || D(b) || 0 === a || "number" == typeof a && a > 0 && a - 1 in b
    }
    ...
    function Ca(b, a, c, d) {
        ...
        } else(a = b) && (D(b) ? a = Ca(b, [], c, d) : fa(b) ? a = new Date(b.getTime()) : lb(b) ? (a = new RegExp(b.source, b.toString().match(/[^\/]*$/)[0]), a.lastIndex = b.lastIndex) : K(b) && (e = Object.create(Object.getPrototypeOf(b)), a = Ca(b, e, c, d)));
        return a
    }
    ...
    function ua(b, a) {
        ...
        } else if (K(b))for (c in a = a || {}, b)("$" !== c.charAt(0) || "$" !== c.charAt(1)) && (a[c] = b[c]);
        return a || b
    }
    ...
    function pa(b, a) {
        ...
        if (c == typeof a && "object" == c) {
            ...
            if ((c = b.length) == a.length) {
                for (d = 0; c > d; d++)if (!pa(b[d], a[d]))return!1;
                return!0
            }
        }
        return!1
    ...
    function Ed(b, a) {
        var c = a;
        return"string" == typeof b && "$" === b.charAt(0) && "$" === b.charAt(1) ? c = u : Sa(a) ? c = "$WINDOW" : a && V === a ? c = "$DOCUMENT" : Ta(a) && (c = "$SCOPE"), c
    }
    ...
    function Fd(b, a) {
        var c, d, e = ob.length;
        for (b = A(b), d = 0; e > d; ++d)if (c = ob[d] + a, I(c = b.attr(c)))return c;
        return null
    }
    ...
    function rc(b, a, c) {
        ...
        var d = function () {
            ...
            }]), a.unshift("ng"), d = Lb(a, c.strictDi), d.invoke(["$rootScope", "$rootElement", "$compile", "$injector", function (a, b, c, d) {
                a.$apply(function () {
                    b.data("$injector", d), c(b)(a)
                })
            }]), d
        }, e = /^NG_ENABLE_DEBUG_INFO!/, f = /^NG_DEFER_BOOTSTRAP!/;
        return U && e.test(U.name) && (c.debugInfoEnabled = !0, U.name = U.name.replace(e, "")), U && !f.test(U.name) ? d() : (U.name = U.name.replace(f, ""), void(ha.resumeBootstrap = function (b) {
            r(b, function (b) {
                a.push(b)
            }), d()
        }))
    ...
    function Mb(b, a) {
        return a = a || "_", b.replace(Jd, function (b, d) {
    ...
    function Kd() {
        var b;
        sc || ((qa = U.jQuery) && qa.fn.on ? (A = qa, C(qa.fn, {scope: Ka.scope, isolateScope: Ka.isolateScope, controller: Ka.controller, injector: Ka.injector, inheritedData: Ka.inheritedData}), b = qa.cleanData, qa.cleanData = function (a) {
            var c;
            if (Nb)Nb = !1; else for (var e, d = 0; null != (e = a[d]); d++)(c = qa._data(e, "events")) && c.$destroy && qa(e).triggerHandler("$destroy");
            b(a)
    ...
    function pb(b, a, c) {
        return c && D(b) && (b = b[b.length - 1]), Ob(F(b), a, "not a function, got " + (b && "object" == typeof b ? b.constructor.name || "Object" : typeof b)), b
    }
    ...
    function Ld(b) {
        ...
        return b = a(b, "angular", Object), b.$$minErr = b.$$minErr || z, a(b, "module", function () {
            var b = {};
    ...
    function Dc(b, a) {
        ...
        if (Pb.test(b)) {
            for (c = c || e.appendChild(a.createElement("div")), d = (af.exec(b) || ["", ""])[1].toLowerCase(), d = ja[d] || ja._default, c.innerHTML = d[1] + b.replace(bf, "<$1></$2>") + d[2], d = d[0]; d--;)c = c.lastChild;
            f = Xa(f, c.childNodes), c = e.firstChild, c.textContent = ""
    ...
    function S(b) {
        ...
        var a;
        if (I(b) && (b = P(b), a = !0), !(this instanceof S)) {
    ...
    function vb(b, a) {
        ...
        return a && !c && (b.ng339 = c = ++df, c = wb[c] = {events: {}, data: {}, handle: u}), c
    }
    ...
    function ef(b, a) {
        a = a || U, "complete" === a.document.readyState ? a.setTimeout(b) : A(a).on("load", b)
    }
    ...
    function gf(b, a) {
        var c = function (c, e) {
            ...
            if (g) {
                ...
                for (var k = 0; g > k; k++)c.isImmediatePropagationStopped() || f[k].call(b, c)
            }
        };
        return c.elem = b, c
    }
    ...
    function Ma(b, a) {
        var c = b && b.$$hashKey;
        return c ? ("function" == typeof c && (c = b.$$hashKey()), c) : (c = typeof b, c = "function" == c || "object" == c && null !== b ? b.$$hashKey = c + ":" + (a || Cd)() : c + ":" + b)
    }
    ...
    function Wb(b, a, c) {
        ...
        if ("function" == typeof b) {
            if (!(d = b.$inject)) {
                if (d = [], b.length) {
                    ...
                    a = b.toString().replace(Mc, ""), a = a.match(Nc), r(a[1].split(jf), function (a) {
        ...
        } else D(b) ? (a = b.length - 1, pb(b[a], "fn"), d = b.slice(0, a)) : pb(b, "fn", !0);
        return d
    }
    ...
    function Lb(b, a) {
        function c(a) {
            return function (b, c) {
                return K(b) ? void r(b, kc(a)) : a(b, c)
            }
        }

        function d(a, b) {
            if (La(a, "service"), (F(b) || D(b)) && (b = s.instantiate(b)), !b.$get)throw Ea("pget", a);
        ...
        this.disableAutoScrolling = function () {
            ...
            function f(b) {
                if (b) {
                    b.scrollIntoView();
                    var c;
                    c = g.yOffset, F(c) ? c = c() : mc(c) ? (c = c[0], c = "fixed" !== a.getComputedStyle(c).position ? 0 : c.getBoundingClientRect().bottom) : X(c) || (c = 0), c && (b = b.getBoundingClientRect().top, a.scrollBy(0, b - c))
                } else a.scrollTo(0, 0)
            }
    ...
    function lf(b, a, c, d) {
        ...
        function h() {
            H = b.history.state, H = G(H) ? null : H, pa(H, Q) && (H = Q), Q = H
        }

        function k() {
            (B !== m.url() || M !== H) && (B = m.url(), M = H, r(W, function (a) {
                a(m.url(), H)
            }))
        }
        ...
        m.addPollFn = function (a) {
            return G(E) && f(100, q), O.push(a), a
        };
        var H, M, B = s.href, ea = a.find("base"), L = null;
        h(), M = H, m.url = function (a, c, e) {
            if (G(e) && (e = null), s !== b.location && (s = b.location), t !== b.history && (t = b.history), a) {
                var f = M === e;
                if (B === a && (!d.history || f))return m;
                var g = B && Fa(B) === Fa(a);
                return B = a, M = e, !d.history || g && f ? (g || (L = a), c ? s.replace(a) : s.href = a) : (t[c ? "replaceState" : "pushState"](e, "", a), h(), M = H), m
            }
        ...
        m.onUrlChange = function (a) {
            return ba || (d.history && A(b).on("popstate", g), A(b).on("hashchange", g), ba = !0), W.push(a), a
        ...
        m.cookies = function (a, b) {
            var d, e, f, g;
            if (!a) {
                if (p.cookie !== y)for (y = p.cookie, d = y.split("; "), aa = {}, f = 0; f < d.length; f++)e = d[f], g = e.indexOf("="), g > 0 && (a = l(e.substring(0, g)), aa[a] === u && (aa[a] = l(e.substring(g + 1))));
                return aa
            }
            b === u ? p.cookie = encodeURIComponent(a) + "=;path=" + da + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : I(b) && (d = (p.cookie = encodeURIComponent(a) + "=" + encodeURIComponent(b) + ";path=" + da).length + 1, d > 4096 && c.warn("Cookie '" + a + "' possibly not set or overflowed because it was too large (" + d + " > 4096 bytes)!"))
        }, m.defer = function (a, b) {
            var c;
            return v++, c = q(function () {
                delete n[c], e(a)
            }, b || 0), n[c] = !0, c
        ...
        this.$get = function () {
            function b(b, d) {
                ...
                return a[b] = {put: function (a, b) {
                    ...
                    return G(b) ? void 0 : (a in k || g++, k[a] = b, g > l && this.remove(s.key), b)
                }, get: function (a) {
                    if (l < Number.MAX_VALUE) {
                        var b = m[a];
                        if (!b)return;
                    ...
                    if (l < Number.MAX_VALUE) {
                        var b = m[a];
                        if (!b)return;
                        b == p && (p = b.p), b == s && (s = b.n), f(b.n, b.p), delete m[a]
                    }
                    delete k[a], g--
                }, removeAll: function () {
                    k = {}, g = 0, m = {}, p = s = null
    ...
    function uc(b, a) {
        ...
        this.directive = function p(a, e) {
            return La(a, "directive"), I(a) ? (Ob(e, "directiveFactory"), d.hasOwnProperty(a) || (d[a] = [], b.factory(a + "Directive", ["$injector", "$exceptionHandler", function (b, e) {
                var f = [];
                return r(d[a], function (d, g) {
                    try {
                        var h = b.invoke(d);
                        F(h) ? h = {compile: ca(h)} : !h.compile && h.link && (h.compile = ca(h.link)), h.priority = h.priority || 0, h.index = g, h.name = h.name || a, h.require = h.require || h.controller && h.name, h.restrict = h.restrict || "EA", K(h.scope) && (h.$$isolateBindings = c(h.scope, h.name)), f.push(h)
                    } catch (k) {
                        e(k)
                    }
                }), f
            }])), d[a].push(e)) : r(a, kc(p)), this
        ...
        this.debugInfoEnabled = function (a) {
            ...
            function B(a, b, c, d, e) {
                ...
                return function (b, c, d) {
                    ...
                    if (d = d.futureParentElement, e && e.$$boundTransclude && (e = e.$$boundTransclude), g || (g = (d = d && d[0]) && "foreignobject" !== ta(d) && d.toString().match(/SVG/) ? "svg" : "html"), d = "html" !== g ? A(U(g, A("<div>").append(a).html())) : c ? Ka.clone.call(a) : a, h)for (var k in h)d.data("$" + k + "Controller", h[k].instance);
                    return B.$$addScopeInfo(d, b), c && c(d, b), f && f(b, d, d, e), d
                }
            }
            ...
            function ea(a, b, c, d, e, f) {
                function g(a, c, d, e) {
                    ...
                    for (q = 0, s = h.length; s > q;)k = w[h[q++]], c = h[q++], f = h[q++], c ? (c.scope ? (l = a.$new(), B.$$addScopeInfo(A(k), l)) : l = a, n = c.transcludeOnThisElement ? L(a, c.transclude, e, c.elementTranscludeOnThisElement) : !c.templateOnThisElement && e ? e : !e && b ? L(a, b) : null, c(f, l, k, d, n)) : f && f(a, k.childNodes, u, e)
                }

                for (var k, l, q, s, p, h = [], n = 0; n < a.length; n++)k = new X, l = W(a[n], [], k, 0 === n ? d : u, e), (f = l.length ? aa(l, a[n], k, b, c, null, [], [], f) : null) && f.scope && B.$$addScopeClass(k.$$element), k = f && f.terminal || !(q = a[n].childNodes) || !q.length ? null : ea(q, f ? (f.transcludeOnThisElement || !f.templateOnThisElement) && f.transclude : b), (f || k) && (h.push(n, f, k), s = !0, p = p || f), f = null;
                return s ? g : null
            }
            ...
            function W(b, c, g, h, k) {
                ...
                switch (b.nodeType) {
                    case na:
                        da(c, wa(ta(b)), "E", h, k);
                        for (var s, n, w, N = b.attributes, t = 0, O = N && N.length; O > t; t++) {
                            var H = !1, v = !1;
                            s = N[t], q = s.name, s = P(s.value), n = wa(q), (w = za.test(n)) && (q = Mb(n.substr(6), "-"));
                            var E, M = n.replace(/(Start|End)$/, "");
                            a:{
                                var B = M;
                                if (d.hasOwnProperty(B)) {
                                    E = void 0;
                                    for (var B = a.get(B + "Directive"), W = 0, r = B.length; r > W; W++)if (E = B[W], E.multiElement) {
                                        E = !0;
                                        break a
                                    }
                                }
                            ...
                            E && n === M + "Start" && (H = q, v = q.substr(0, q.length - 5) + "end", q = q.substr(0, q.length - 6)), n = wa(q.toLowerCase()), l[n] = q, (w || !g.hasOwnProperty(n)) && (g[n] = s, Jc(b, n) && (g[n] = !0)), S(b, c, s, n, w), da(c, n, "A", h, k, H, v)
                        }
                        if (b = b.className, I(b) && "" !== b)for (; q = f.exec(b);)n = wa(q[2]), da(c, n, "C", h, k) && (g[n] = P(q[3])), b = b.substr(q.index + q[0].length);
                        break;
                    case mb:
                        T(c, b.nodeValue);
                        break;
                    case 8:
                        try {
                            (q = e.exec(b.nodeValue)) && (n = wa(q[1]), da(c, n, "M", h, k) && (g[n] = P(q[2])))
                        } catch (Q) {
                        }
                }
                return c.sort(z), c
            ...
            function aa(a, d, e, f, g, k, l, q, p) {
                function w(a, b, c, d) {
                    a && (c && (a = Q(a, c, d)), a.require = J.require, a.directiveName = ga, (L === J || J.$$isolateScope) && (a = Y(a, {isolateScope: !0})), l.push(a)), b && (c && (b = Q(b, c, d)), b.require = J.require, b.directiveName = ga, (L === J || J.$$isolateScope) && (b = Y(b, {isolateScope: !0})), q.push(b))
                }

                function O(a, b, c, d) {
                    var e, l, f = "data", g = !1, k = c;
                    if (I(b)) {
                        if (l = b.match(h), b = b.substring(l[0].length), l[3] && (l[1] ? l[3] = null : l[1] = l[3]), "^" === l[1] ? f = "inheritedData" : "^^" === l[1] && (f = "inheritedData", k = c.parent()), "?" === l[2] && (g = !0), e = null, d && "data" === f && (e = d[b]) && (e = e.instance), e = e || k[f]("$" + b + "Controller"), !e && !g)throw ka("ctreq", b, a);
                        return e || null
                    }
                    return D(b) && (e = [], r(b, function (b) {
                        e.push(O(a, b, c, d))
                    })), e
                }
                ...
                function H(a, c, f, g, h) {
                    function k(a, b, c) {
                        var d;
                        return Ta(a) || (c = b, b = a, a = u), C && (d = M), c || (c = C ? W.parent() : W), h(a, b, d, c, Xb)
                    }

                    var p, w, t, v, M, db, W, Q;
                    if (d === f ? (Q = e, W = e.$$element) : (W = A(f), Q = new X(W, e)), L && (v = c.$new(!0)), h && (db = k, db.$$boundTransclude = h), E && (ea = {}, M = {}, r(E, function (a) {
                        var b = {$scope: a === L || a.$$isolateScope ? v : c, $element: W, $attrs: Q, $transclude: db};
                        t = a.controller, "@" == t && (t = Q[a.name]), b = n(t, b, !0, a.controllerAs), M[a.name] = b, C || W.data("$" + a.name + "Controller", b.instance), ea[a.name] = b
                    })), L) {
                        B.$$addScopeInfo(W, v, !0, !(aa && (aa === L || aa === L.$$originalDirective))), B.$$addScopeClass(W, !0), g = ea && ea[L.name];
                        var ba = v;
                        g && g.identifier && !0 === L.bindToController && (ba = g.instance), r(v.$$isolateBindings = L.$$isolateBindings, function (a, d) {
                            var g, h, k, l, e = a.attrName, f = a.optional;
                            switch (a.mode) {
                                case"@":
                                    Q.$observe(e, function (a) {
                                        ba[d] = a
                                    }), Q.$$observers[e].$$scope = c, Q[e] && (ba[d] = b(Q[e])(c));
                                    break;
                                case"=":
                                    if (f && !Q[e])break;
                                    h = N(Q[e]), l = h.literal ? pa : function (a, b) {
                                        return a === b || a !== a && b !== b
                                    }, k = h.assign || function () {
                                        throw g = ba[d] = h(c), ka("nonassign", Q[e], L.name)
                                    }, g = ba[d] = h(c), f = function (a) {
                                        return l(a, ba[d]) || (l(a, g) ? k(c, a = ba[d]) : ba[d] = a), g = a
                                    }, f.$stateful = !0, f = a.collection ? c.$watchCollection(Q[e], f) : c.$watch(N(Q[e], f), null, h.literal), v.$on("$destroy", f);
                                    break;
                                case"&":
                    ...
                    for (ea && (r(ea, function (a) {
                        a()
                    }), ea = null), g = 0, p = l.length; p > g; g++)w = l[g], Z(w, w.isolateScope ? v : c, W, Q, w.require && O(w.directiveName, w.require, W, M), db);
                    var Xb = c;
                    for (L && (L.template || null === L.templateUrl) && (Xb = v), a && a(Xb, f.childNodes, u, h), g = q.length - 1; g >= 0; g--)w = q[g], Z(w, w.isolateScope ? v : c, W, Q, w.require && O(w.directiveName, w.require, W, M), db)
                }

                p = p || {};
                for (var M, ea, J, ga, z, R, v = -Number.MAX_VALUE, E = p.controllerDirectives, L = p.newIsolateScopeDirective, aa = p.templateDirective, da = p.nonTlbTranscludeDirective, x = !1, Na = !1, C = p.hasElementTranscludeDirective, T = e.$$element = A(d), Ga = f, S = 0, za = a.length; za > S; S++) {
                    J = a[S];
                    var zb = J.$$start, $ = J.$$end;
                    if (zb && (T = ba(d, zb, $)), z = u, v > J.priority)break;
                    if ((z = J.scope) && (J.templateUrl || (K(z) ? (ya("new/isolated scope", L || M, J, T), L = J) : ya("new/isolated scope", L, J, T)), M = M || J), ga = J.name, !J.templateUrl && J.controller && (z = J.controller, E = E || {}, ya("'" + ga + "' controller", E[ga], J, T), E[ga] = J), (z = J.transclude) && (x = !0, J.$$tlb || (ya("transclusion", da, J, T), da = J), "element" == z ? (C = !0, v = J.priority, z = T, T = e.$$element = A(V.createComment(" " + ga + ": " + e[ga] + " ")), d = T[0], Ab(g, Ya.call(z, 0), d), Ga = B(z, f, v, k && k.name, {nonTlbTranscludeDirective: da})) : (z = A(Rb(d)).contents(), T.empty(), Ga = B(z, f))), J.template)if (Na = !0, ya("template", aa, J, T), aa = J, z = F(J.template) ? J.template(T, e) : J.template, z = Pc(z), J.replace) {
                        if (k = J, z = Pb.test(z) ? Qc(U(J.templateNamespace, P(z))) : [], d = z[0], 1 != z.length || d.nodeType !== na)throw ka("tplrt", ga, "");
                        Ab(g, T, d), za = {$attr: {}}, z = W(d, [], za);
                        var mf = a.splice(S + 1, a.length - (S + 1));
                        L && y(z), a = a.concat(z).concat(mf), Oc(e, za), za = a.length
                    } else T.html(z);
                ...
                return H.scope = M && !0 === M.scope, H.transcludeOnThisElement = x, H.elementTranscludeOnThisElement = C, H.templateOnThisElement = Na, H.transclude = Ga, p.hasElementTranscludeDirective = C, H
            }

            function y(a) {
                for (var b = 0, c = a.length; c > b; b++) {
                    var e, d = b;
                    e = C(Object.create(a[b]), {$$isolateScope: !0}), a[d] = e
                }
            }
            ...
            function da(b, e, f, g, h, k, l) {
                ...
                if (h = null, d.hasOwnProperty(e)) {
                    var q;
                    e = a.get(e + "Directive");
                    for (var s = 0, n = e.length; n > s; s++)try {
            ...
            function G(a, b, c, d, e, f, g, h) {
                var l, s, k = [], p = b[0], n = a.shift(), w = C({}, n, {templateUrl: null, transclude: null, replace: null, $$originalDirective: n}), N = F(n.templateUrl) ? n.templateUrl(b, c) : n.templateUrl, t = n.templateNamespace;
                return b.empty(), q(O.getTrustedResourceUrl(N)).then(function (q) {
                    var v, O;
                    if (q = Pc(q), n.replace) {
                        if (q = Pb.test(q) ? Qc(U(t, P(q))) : [], v = q[0], 1 != q.length || v.nodeType !== na)throw ka("tplrt", n.name, N);
                        q = {$attr: {}}, Ab(d, b, v);
                        var H = W(v, [], q);
                        K(n.scope) && y(H), a = H.concat(a), Oc(c, q)
                    } else v = p, b.html(q);
                    for (a.unshift(w), l = aa(a, v, c, e, b, n, f, g, h), r(d, function (a, c) {
                        a == v && (d[c] = b[0])
                    }), s = ea(b[0].childNodes, e); k.length;) {
                        q = k.shift(), O = k.shift();
                        var E = k.shift(), B = k.shift(), H = b[0];
                        if (!q.$$destroyed) {
                            if (O !== p) {
                                var Q = O.className;
                                h.hasElementTranscludeDirective && n.replace || (H = Rb(v)), Ab(E, A(O), H), M(A(H), Q)
                            }
                            O = l.transcludeOnThisElement ? L(q, l.transclude, B) : B, l(s, q, H, d, O)
                        }
                    }
                    k = null
                }), function (a, b, c, d, e) {
                    a = e, b.$$destroyed || (k ? k.push(b, c, d, a) : (l.transcludeOnThisElement && (a = L(b, l.transclude, e)), l(s, b, c, d, a)))
                }
            }
            ...
            function T(a, c) {
                ...
                d && a.push({priority: 0, compile: function (a) {
                    a = a.parent();
                    var b = !!a.length;
                    return b && B.$$addBindingClass(a), function (a, c) {
                        var e = c.parent();
                        b || B.$$addBindingClass(e), B.$$addBindingInfo(e, d.expressions), a.$watch(d, function (a) {
                            c[0].nodeValue = a
                        })
                    }
                }})
            ...
            function Ga(a, b) {
                ...
                var c = ta(a);
                return"xlinkHref" == b || "form" == c && "action" == b || "img" != c && ("src" == b || "ngSrc" == b) ? O.RESOURCE_URL : void 0
            }
                ...
                if (h) {
                    ...
                    c.push({priority: 100, compile: function () {
                        return{pre: function (c, d, l) {
                            if (d = l.$$observers || (l.$$observers = {}), k.test(e))throw ka("nodomevents");
            ...
            function Ab(a, b, c) {
                ...
                for (f && f.replaceChild(c, d), a = V.createDocumentFragment(), a.appendChild(d), A(c).data(A(d).data()), qa ? (Nb = !0, qa.cleanData([d])) : delete A.cache[d[A.expando]], d = 1, e = b.length; e > d; d++)f = b[d], A(f).remove(), a.appendChild(f), delete b[d];
                b[0] = c, b.length = 1
            }
            ...
            X.prototype = {$normalize: wa, $addClass: function (a) {
                ...
                var c = Rc(a, b);
                c && c.length && E.addClass(this.$$element, c), (c = Rc(b, a)) && c.length && E.removeClass(this.$$element, c)
            }, $set: function (a, b, d, e) {
                var f = this.$$element[0], g = Jc(f, a), h = ff(f, a), f = a;
                if (g ? (this.$$element.prop(a, b), e = g) : h && (this[h] = b, f = h), this[a] = b, e ? this.$attr[a] = e : (e = this.$attr[a]) || (this.$attr[a] = e = Mb(a, "-")), g = ta(this.$$element), "a" === g && "href" === a || "img" === g && "src" === a)this[a] = b = H(b, "src" === a); else if ("img" === g && "srcset" === a) {
                    for (var g = "", h = P(b), k = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, k = /\s/.test(h) ? k : /(,)/, h = h.split(k), k = Math.floor(h.length / 2), l = 0; k > l; l++)var q = 2 * l, g = g + H(P(h[q]), !0), g = g + (" " + P(h[q + 1]));
                    h = P(h[2 * l]).split(/\s/), g += H(P(h[0]), !0), 2 === h.length && (g += " " + P(h[1])), this[a] = b = g
                }
            ...
            return B.$$addBindingInfo = l ? function (a, b) {
                var c = a.data("$binding") || [];
                D(b) ? c = c.concat(b) : c.push(b), a.data("$binding", c)
            } : x, B.$$addBindingClass = l ? function (a) {
                M(a, "ng-binding")
            } : x, B.$$addScopeInfo = l ? function (a, b, c, d) {
                a.data(c ? d ? "$isolateScopeNoTemplate" : "$isolateScope" : "$scope", b)
            } : x, B.$$addScopeClass = l ? function (a, b) {
    ...
    function Ce() {
        ...
        this.register = function (a, c) {
            La(a, "controller"), K(a) ? C(b, a) : b[a] = c
            ...
            return function (g, h, k, l) {
                var m, p, s;
                return k = !0 === k, l && I(l) && (s = l), I(g) && (l = g.match(c), p = l[1], s = s || l[3], g = b.hasOwnProperty(p) ? b[p] : tc(h.$scope, p, !0) || (a ? tc(e, p, !0) : u), pb(g, p, !0)), k ? (k = (D(g) ? g[g.length - 1] : g).prototype, m = Object.create(k), s && f(h, s, m, p || g.name), C(function () {
                    return d.invoke(g, m, h, p), m
                }, {instance: m, identifier: s})) : (m = d.instantiate(g, h, p), s && f(h, s, m, p || g.name), m)
            }
        }]
    }
    ...
    function Yb(b, a) {
        if (I(b)) {
            ...
            (c && 0 === c.indexOf(Sc) && b.trim() || qf.test(b) && rf.test(b)) && (b = oc(b))
        }
        return b
    }
    ...
    function Tc(b) {
        var c, d, e, a = ia();
        return b ? (r(b.split("\n"), function (b) {
            e = b.indexOf(":"), c = R(P(b.substr(0, e))), d = P(b.substr(e + 1)), c && (a[c] = a[c] ? a[c] + ", " + d : d)
        }), a) : a
    }
    ...
    function Uc(b) {
        var a = K(b) ? b : u;
        return function (c) {
            return a || (a = Tc(b)), c ? (c = a[R(c)], void 0 === c && (c = null), c) : a
        }
    }
    ...
    function He() {
        ...
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function (d, e, f, g, h, k) {
            function l(a) {
                function c(a) {
                    var b = C({}, a);
                    return b.data = a.data ? Vc(a.data, a.headers, d.transformResponse) : a.data, a = a.status, a >= 200 && 300 > a ? b : h.reject(b)
                }

                var d = {method: "get", transformRequest: b.transformRequest, transformResponse: b.transformResponse}, e = function (a) {
                    var e, f, c = b.headers, d = C({}, a.headers), c = C({}, c.common, c[R(a.method)]);
                    a:for (e in c) {
                        a = R(e);
                ...
                C(d, a), d.headers = e, d.method = rb(d.method);
                var f = [function (a) {
                    e = a.headers;
                    var d = Vc(a.data, Uc(e), a.transformRequest);
                    return G(d) && r(e, function (a, b) {
                        "content-type" === R(b) && delete e[b]
                    }), G(a.withCredentials) && !G(b.withCredentials) && (a.withCredentials = b.withCredentials), m(a, d, e).then(c, c)
                }, u], g = h.when(d);
                for (r(t, function (a) {
            ...
            function m(c, f, k) {
                function m(b, c, d, e) {
                    ...
                    M && (b >= 200 && 300 > b ? M.put(r, [b, c, Tc(d), e]) : M.remove(r)), a ? g.$applyAsync(f) : (f(), g.$$phase || g.$apply())
                }

                function w(a, b, d, e) {
                    b = Math.max(b, 0), (b >= 200 && 300 > b ? E.resolve : E.reject)({data: a, status: b, headers: Uc(d), config: c, statusText: e})
                }
                ...
                var M, B, E = h.defer(), H = E.promise, r = p(c.url, c.params);
                if (l.pendingRequests.push(c), H.then(t, t), !c.cache && !b.cache || !1 === c.cache || "GET" !== c.method && "JSONP" !== c.method || (M = K(c.cache) ? c.cache : K(b.cache) ? b.cache : s), M)if (B = M.get(r), y(B)) {
                    if (B && F(B.then))return B.then(t, t), B;
                    D(B) ? w(B[1], B[0], ua(B[2]), B[3]) : w(B, 200, {}, "OK")
                } else M.put(r, H);
                return G(B) && ((B = Wc(c.url) ? e.cookies()[c.xsrfCookieName || b.xsrfCookieName] : u) && (k[c.xsrfHeaderName || b.xsrfHeaderName] = B), d(c.method, r, f, m, k, c.timeout, c.withCredentials, c.responseType)), H
            }

            function p(a, b) {
                if (!b)return a;
                var c = [];
                return Bd(b, function (a, b) {
                    null === a || G(a) || (D(a) || (a = [a]), r(a, function (a) {
                        K(a) && (a = fa(a) ? a.toISOString() : Za(a)), c.push(Da(b) + "=" + Da(a))
                    }))
    ...
    function tf(b, a, c, d, e) {
        ...
        return function (e, h, k, l, m, p, s, t) {
            ...
            function N(a, d, e, f, g) {
                E && c.cancel(E), v = w = null, a(d, e, f, g), b.$$completeOutstandingRequest(x)
            }
            ...
            if (b.$$incOutstandingRequestCount(), h = h || b.url(), "jsonp" == R(e)) {
                ...
                var v = f(h.replace("JSON_CALLBACK", "angular.callbacks." + n), n, function (a, b) {
                    N(l, a, d[n].data, "", b), d[n] = x
                })
            } else {
                var w = a();
                if (w.open(e, h, !0), r(m, function (a, b) {
                    y(a) && w.setRequestHeader(b, a)
                }), w.onload = function () {
                    var a = w.statusText || "", b = "response"in w ? w.response : w.responseText, c = 1223 === w.status ? 204 : w.status;
                    0 === c && (c = b ? 200 : "file" == Aa(h).protocol ? 404 : 0), N(l, c, b, w.getAllResponseHeaders(), a)
                }, e = function () {
                    N(l, -1, null, null, "")
                }, w.onerror = e, w.onabort = e, s && (w.withCredentials = !0), t)try {
                    w.responseType = t
                } catch (O) {
                    if ("json" !== t)throw O
                }
            ...
            if (p > 0)var E = c(q, p); else p && F(p.then) && p.then(q)
        }
    }
    ...
    function Fe() {
        ...
        this.startSymbol = function (a) {
            ...
            function g(f, g, t, q) {
                ...
                q = !!q;
                for (var v, w, O = 0, E = [], H = [], M = f.length, B = [], r = []; M > O;) {
    ...
    function Ge() {
        this.$get = ["$rootScope", "$window", "$q", "$$q", function (b, a, c, d) {
            function e(e, h, k, l) {
                ...
                return k = y(k) ? k : 0, N.then(null, null, e), N.$$intervalId = m(function () {
                    q.notify(s++), k > 0 && s >= k && (q.resolve(s), p(N.$$intervalId), delete f[N.$$intervalId]), t || b.$apply()
                }, h), f[N.$$intervalId] = q, N
            }
    ...
    function Xc(b, a) {
        var c = Aa(b);
        a.$$protocol = c.protocol, a.$$host = c.hostname, a.$$port = $(c.port) || uf[c.protocol] || null
    }
    ...
    function cc(b, a) {
        this.$$html5 = !0, a = a || "";
        var c = bc(b);
        Xc(b, this), this.$$parse = function (a) {
            var b = xa(c, a);
            if (!I(b))throw eb("ipthprfx", a, c);
            Yc(b, this), this.$$path || (this.$$path = "/"), this.$$compose()
            ...
            var f, g;
            return(f = xa(b, d)) !== u ? (g = f, g = (f = xa(a, f)) !== u ? c + (xa("/", f) || f) : b + g) : (f = xa(c, d)) !== u ? g = c + f : c == d + "/" && (g = c), g && this.$$parse(g), !!g
        }
    }

    function dc(b, a) {
        var c = bc(b);
        Xc(b, this), this.$$parse = function (d) {
            var e = xa(b, d) || xa(c, d), e = "#" == e.charAt(0) ? xa(a, e) : this.$$html5 ? e : "";
            if (!I(e))throw eb("ihshprfx", d, a);
            Yc(e, this), d = this.$$path;
            var f = /^\/[A-Z]:(\/.*)/;
    ...
    function Zc(b, a) {
        ...
        this.$$parseLinkUrl = function (d, e) {
            if (e && "#" === e[0])return this.hash(e.slice(1)), !0;
            var f, g;
            return b == Fa(d) ? f = d : (g = xa(c, d)) ? f = b + a + g : c === d + "/" && (f = c), f && this.$$parse(f), !!f
        }, this.$$compose = function () {
            var c = Kb(this.$$search), e = this.$$hash ? "#" + nb(this.$$hash) : "";
    ...
    function $c(b, a) {
        return function (c) {
            return G(c) ? this[b] : (this[b] = a(c), this.$$compose(), this)
        }
    }
    ...
    function Je() {
        ...
        this.hashPrefix = function (a) {
            ...
            if (a.enabled) {
                ...
                p = m.substring(0, m.indexOf("/", m.indexOf("//") + 2)) + (l || "/"), l = e.history ? cc : Zc
            } else p = Fa(m), l = dc;
            k = new l(p, "#" + b), k.$$parseLinkUrl(m, m), k.$$state = d.state();
            ...
            f.on("click", function (b) {
                if (a.rewriteLinks && !b.ctrlKey && !b.metaKey && 2 != b.which) {
                    ...
                    K(g) && "[object SVGAnimatedString]" === g.toString() && (g = Aa(g.animVal).href), s.test(g) || !g || e.attr("target") || b.isDefaultPrevented() || !k.$$parseLinkUrl(g, h) || (b.preventDefault(), k.absUrl() != d.url() && (c.$apply(), U.angular["ff-684208-preventDefault"] = !0))
                }
            ...
            return d.onUrlChange(function (a, b) {
                c.$evalAsync(function () {
                    ...
                    k.$$parse(a), k.$$state = b, f = c.$broadcast("$locationChangeStart", a, d, b, e).defaultPrevented, k.absUrl() === a && (f ? (k.$$parse(d), k.$$state = e, g(d, !1, e)) : (t = !1, h(d, e)))
                }), c.$$phase || c.$digest()
            }), c.$watch(function () {
                var a = d.url(), b = d.state(), f = k.$$replace, l = a !== k.absUrl() || k.$$html5 && e.history && b !== k.$$state;
                (t || l) && (t = !1, c.$evalAsync(function () {
    ...
    function Oa(b, a, c, d) {
        ...
        return e = ra(a.shift(), d), sa(b[e], d), b[e] = c
    }
    ...
    function ad(b, a, c, d, e, f, g) {
        ...
        return function (f, g) {
            ...
            return null == h ? h : (h = k(h[b]), a ? null == h ? u : (h = l(h[a]), c ? null == h ? u : (h = m(h[c]), d ? null == h ? u : (h = p(h[d]), e ? null == h ? u : h = s(h[e]) : h) : h) : h) : h)
        }
    }
    ...
    function bd(b, a, c) {
        ...
        if (a.csp)f = 6 > h ? ad(g[0], g[1], g[2], g[3], g[4], c, d) : function (a, b) {
            var f, e = 0;
            do f = ad(g[e++], g[e++], g[e++], g[e++], g[e++], c, d)(a, b), b = u, a = f; while (h > e);
            return f
        }; else {
            var k = "";
            d && (k += "s = eso(s, fe);\nl = eso(l, fe);\n");
            ...
            r(g, function (a, b) {
                ...
                (d || Pa(a)) && (e = "eso(" + e + ", fe)", l = !0), k += "if(s == null) return undefined;\ns=" + e + ";\n"
            }), k += "return s;", a = new Function("s", "l", "eso", "fe", k), a.toString = ca(k), l && (a = vf(a, c)), f = a
        }
        ...
        this.$get = ["$filter", "$sniffer", function (c, d) {
            ...
            function h(a, b, c, d) {
                ...
                if (1 === e.length) {
                    ...
                    return a.$watch(function (a) {
                        var b = e(a);
                        return g(b, k) || (h = d(a), k = b && fc(b)), h
                    }, b, c)
                }
                for (var l = [], s = 0, m = e.length; m > s; s++)l[s] = g;
                return a.$watch(function (a) {
                    for (var b = !1, c = 0, f = e.length; f > c; c++) {
                        var k = e[c](a);
                        (b || (b = !g(k, l[c]))) && (l[c] = k && fc(k))
                    }
                    return b && (h = d(a)), h
                }, b, c)
            }
            ...
            function k(a, b, c, d) {
                ...
                return e = a.$watch(function (a) {
                    ...
                    f = a, F(b) && b.apply(this, arguments), y(a) && d.$$postDigest(function () {
                        y(f) && e()
                    })
                }, c)
            }
            ...
            return function (d, f, g) {
                ...
                switch (typeof d) {
                    case"string":
                        O = d = d.trim();
                        var E = g ? a : b;
                        return v = E[O], v || (":" === d.charAt(0) && ":" === d.charAt(1) && (w = !0, d = d.substring(2)), g = g ? t : s, v = new gc(g), v = new fb(v, c, g).parse(d), v.constant ? v.$$watchDelegate = m : w ? (v = e(v), v.$$watchDelegate = v.literal ? l : k) : v.inputs && (v.$$watchDelegate = h), E[O] = v), p(v, f);
                    case"function":
                        return p(d, f);
                    default:
                        return p(x, f)
    ...
    function cd(b, a) {
        ...
        d.prototype = {then: function (a, b, c) {
            ...
            try {
                (K(b) || F(b)) && (d = b && b.then), F(d) ? (this.promise.$$state.status = -1, d.call(b, e[0], e[1], this.notify)) : (this.promise.$$state.value = b, this.promise.$$state.status = 1, f(this.promise.$$state))
            } catch (g) {
                e[1](g), a(g)
            }
        }, reject: function (a) {
    ...
    function Me() {
        ...
        this.digestTtl = function (a) {
            ...
            function k() {
                this.$id = ++kb, this.$$phase = this.$parent = this.$$watchers = this.$$nextSibling = this.$$prevSibling = this.$$childHead = this.$$childTail = null, this.$root = this, this.$$destroyed = !1, this.$$listeners = {}, this.$$listenerCount = {}, this.$$isolateBindings = null
            }
            ...
            k.prototype = {constructor: k, $new: function (a, b) {
                ...
                return b = b || this, a ? (d = new k, d.$root = this.$root) : (this.$$ChildScope || (this.$$ChildScope = function () {
                    this.$$watchers = this.$$nextSibling = this.$$childHead = this.$$childTail = null, this.$$listeners = {}, this.$$listenerCount = {}, this.$id = ++kb, this.$$ChildScope = null
                ...
                return c = null, F(b) || (h.fn = x), f || (f = this.$$watchers = []), f.unshift(h), function () {
                    Va(f, h), c = null
                }
                ...
                function c(a) {
                    ...
                    var b, d, g, h;
                    if (!G(e)) {
                        if (K(e))if (Ra(e))for (f !== p && (f = p, n = f.length = 0, l++), a = e.length, n !== a && (l++, f.length = n = a), b = 0; a > b; b++)h = f[b], g = e[b], d = h !== h && g !== g, d || h === g || (l++, f[b] = g); else {
                            f !== s && (f = s = {}, n = 0, l++), a = 0;
                ...
                c.$stateful = !0;
                var e, f, h, d = this, k = 1 < b.length, l = 0, m = g(a, c), p = [], s = {}, q = !0, n = 0;
                return this.$watch(m, function () {
                    if (q ? (q = !1, b(e, e, d)) : b(e, h, d), k)if (K(e))if (Ra(e)) {
                        h = Array(e.length);
                        for (var a = 0; a < e.length; a++)h[a] = e[a]
                    } else for (a in h = {}, e)Jb.call(e, a) && (h[a] = e[a]); else h = e
                })
            }, $digest: function () {
                var e, g, k, m, t, v, L, y, Q, r = b, u = [];
                l("$digest"), h.$$checkUrlChange(), this === q && null !== d && (h.defer.cancel(d), s()), c = null;
                do {
                    for (v = !1, L = this; N.length;) {
                        try {
                    ...
                    a:do {
                        if (m = L.$$watchers)for (t = m.length; t--;)try {
                            if (e = m[t])if ((g = e.get(L)) === (k = e.last) || (e.eq ? pa(g, k) : "number" == typeof g && "number" == typeof k && isNaN(g) && isNaN(k))) {
                                if (e === c) {
                                    v = !1;
                                    break a
                                }
                            } else v = !0, c = e, e.last = e.eq ? Ca(g, null) : g, e.fn(g, k === p ? g : k, L), 5 > r && (y = 4 - r, u[y] || (u[y] = []), u[y].push({msg: F(e.exp) ? "fn: " + (e.exp.name || e.exp.toString()) : e.exp, newVal: g, oldVal: k}))
                        } catch (A) {
                            f(A)
                        }
                ...
                if (!this.$$destroyed) {
                    var a = this.$parent;
                    if (this.$broadcast("$destroy"), this.$$destroyed = !0, this !== q) {
                ...
                var d, l, m, c = [], e = this, g = !1, h = {name: a, targetScope: e, stopPropagation: function () {
                    g = !0
                }, preventDefault: function () {
                    h.defaultPrevented = !0
                }, defaultPrevented: !1}, k = Xa([h], arguments, 1);
                do {
                ...
                for (var h, k, g = Xa([e], arguments, 1); c = d;) {
    ...
    function zf(b) {
        ...
        if (I(b)) {
            ...
            return b = dd(b).replace("\\*\\*", ".*").replace("\\*", "[^:/.?&;]*"), new RegExp("^" + b + "$")
        }
    ...
    function Qe() {
        ...
        this.resourceUrlWhitelist = function (a) {
            return arguments.length && (b = ed(a)), b
        }, this.resourceUrlBlacklist = function (b) {
            return arguments.length && (a = ed(b)), a
            ...
            return h[ma.HTML] = e(g), h[ma.CSS] = e(g), h[ma.URL] = e(g), h[ma.JS] = e(g), h[ma.RESOURCE_URL] = e(h[ma.URL]), {trustAs: function (a, b) {
                ...
                if (c === ma.RESOURCE_URL) {
                    var p, s, g = Aa(e.toString()), t = !1;
                    for (p = 0, s = b.length; s > p; p++)if (d(b[p], g)) {
                        t = !0;
                        break
                    }
                    if (t)for (p = 0, s = a.length; s > p; p++)if (d(a[p], g)) {
                        t = !1;
                        break
                    }
                    if (t)return e;
    ...
    function Re() {
        this.$get = ["$window", "$document", function (b, a) {
            var g, c = {}, d = $((/android (\d+)/.exec(R((b.navigator || {}).userAgent)) || [])[1]), e = /Boxee/i.test((b.navigator || {}).userAgent), f = a[0] || {}, h = /^(Moz|webkit|ms)(?=[A-Z])/, k = f.body && f.body.style, l = !1, m = !1;
            if (k) {
                for (var p in k)if (l = h.exec(p)) {
                    g = l[0], g = g.substr(0, 1).toUpperCase() + g.substr(1);
                    break
                }
                g || (g = "WebkitOpacity"in k && "webkit"), l = !!("transition"in k || g + "Transition"in k), m = !!("animation"in k || g + "Animation"in k), !d || l && m || (l = I(f.body.style.webkitTransition), m = I(f.body.style.webkitAnimation))
            }
        ...
        this.$get = ["$templateCache", "$http", "$q", function (b, a, c) {
            function d(e, f) {
                ...
                return a.get(e, {cache: b, transformResponse: g}).then(function (a) {
                    return a = a.data, d.totalPendingRequests--, b.put(e, a), a
                }, function () {
                    if (d.totalPendingRequests--, !f)throw ka("tpload", e);
                    return c.reject()
                })
            }
    ...
    function Aa(b) {
        return Ha && (Y.setAttribute("href", b), b = Y.href), Y.setAttribute("href", b), {href: Y.href, protocol: Y.protocol ? Y.protocol.replace(/:$/, "") : "", host: Y.host, search: Y.search ? Y.search.replace(/^\?/, "") : "", hash: Y.hash ? Y.hash.replace(/^#/, "") : "", hostname: Y.hostname, port: Y.port, pathname: "/" === Y.pathname.charAt(0) ? Y.pathname : "/" + Y.pathname}
    }

    function Wc(b) {
        return b = I(b) ? Aa(b) : b, b.protocol === fd.protocol && b.host === fd.host
    }
    ...
    function Bc(b) {
        ...
        }], a("currency", gd), a("date", hd), a("filter", Af), a("json", Bf), a("limitTo", Cf), a("lowercase", Df), a("number", id), a("orderBy", jd), a("uppercase", Ef)
    }
    ...
    function gd(b) {
        ...
        return function (b, d, e) {
            return G(d) && (d = a.CURRENCY_SYM), G(e) && (e = a.PATTERNS[1].maxFrac), null == b ? b : kd(b, a.PATTERNS[1], a.GROUP_SEP, a.DECIMAL_SEP, e).replace(/\u00A4/g, d)
        }
    }
    ...
    function kd(b, a, c, d, e) {
        ...
        if (l)e > 0 && b > -1 && 1 > b && (h = b.toFixed(e)); else {
            g = (g.split(ld)[1] || "").length, G(e) && (e = Math.min(Math.max(a.minFrac, g), a.maxFrac)), b = +(Math.round(+(b.toString() + "e" + e)).toString() + "e" + -e), 0 === b && (f = !1), b = ("" + b).split(ld), g = b[0], b = b[1] || "";
            var m = 0, p = a.lgSize, s = a.gSize;
            if (g.length >= p + s)for (m = g.length - p, l = 0; m > l; l++)0 === (m - l) % s && 0 !== l && (h += c), h += g.charAt(l);
            for (l = m; l < g.length; l++)0 === (g.length - l) % p && 0 !== l && (h += c), h += g.charAt(l);
            for (; b.length < e;)b += "0";
            e && "0" !== e && (h += d + b.substr(0, e))
        }
        return k.push(f ? a.negPre : a.posPre, h, f ? a.negSuf : a.posSuf), k.join("")
    }
    ...
    function Z(b, a, c, d) {
        return c = c || 0, function (e) {
            return e = e["get" + b](), (c > 0 || e > -c) && (e += c), 0 === e && -12 == c && (e = 12), Cb(e, a, d)
        }
    }
    ...
    function nd(b) {
        return function (a) {
            ...
            return a = +new Date(a.getFullYear(), a.getMonth(), a.getDate() + (4 - a.getDay())) - +c, a = 1 + Math.round(a / 6048e5), Cb(a, b)
        }
    }
    ...
    function hd(b) {
        function a(a) {
            ...
            if (b = a.match(c)) {
                ...
                b[9] && (f = $(b[9] + b[10]), g = $(b[9] + b[11])), h.call(a, $(b[1]), $(b[2]) - 1, $(b[3])), f = $(b[4] || 0) - f, g = $(b[5] || 0) - g, h = $(b[6] || 0), b = Math.round(1e3 * parseFloat("0." + (b[7] || 0))), k.call(a, f, g, h, b)
            }
            return a
        }
        ...
        return function (c, e, f) {
            var k, l, g = "", h = [];
            if (e = e || "mediumDate", e = b.DATETIME_FORMATS[e] || e, I(c) && (c = Ff.test(c) ? $(c) : a(c)), X(c) && (c = new Date(c)), !fa(c))return c;
            for (; e;)(l = Gf.exec(e)) ? (h = Xa(h, l, 1), e = h.pop()) : (h.push(e), e = null);
            return f && "UTC" === f && (c = new Date(c.getTime()), c.setMinutes(c.getMinutes() + c.getTimezoneOffset())), r(h, function (a) {
                k = Hf[a], g += k ? k(c, b.DATETIME_FORMATS) : a.replace(/(^'|'$)/g, "").replace(/''/g, "'")
            }), g
        }
    }
    ...
    function Cf() {
        return function (b, a) {
            if (X(b) && (b = b.toString()), !D(b) && !I(b))return b;
            if (a = 1 / 0 === Math.abs(Number(a)) ? Number(a) : $(a), I(b))return a ? a >= 0 ? b.slice(0, a) : b.slice(a, b.length) : "";
            var d, e, c = [];
    ...
    function jd(b) {
        return function (a, c, d) {
            ...
            function f(a, b) {
                ...
                return c == d ? (fa(a) && fa(b) && (a = a.valueOf(), b = b.valueOf()), "string" == c && (a = a.toLowerCase(), b = b.toLowerCase()), a === b ? 0 : b > a ? -1 : 1) : d > c ? -1 : 1
            }

            return Ra(a) ? (c = D(c) ? c : [c], 0 === c.length && (c = ["+"]), c = c.map(function (a) {
                var c = !1, d = a || oa;
                if (I(a)) {
    ...
    function Ia(b) {
        return F(b) && (b = {link: b}), b.restrict = b.restrict || "AC", ca(b)
    }

    function od(b, a, c, d, e) {
        var f = this, g = [], h = f.$$parentForm = b.parent().controller("form") || Eb;
        f.$error = {}, f.$$success = {}, f.$pending = u, f.$name = e(a.name || a.ngForm || "")(c), f.$dirty = !1, f.$pristine = !0, f.$valid = !0, f.$invalid = !1, f.$submitted = !1, h.$addControl(f), f.$rollbackViewValue = function () {
            r(g, function (a) {
                a.$rollbackViewValue()
            })
            ...
            La(a.$name, "input"), g.push(a), a.$name && (f[a.$name] = a)
            ...
            d.removeClass(b, Qa), d.addClass(b, Fb), f.$dirty = !0, f.$pristine = !1, h.$setDirty()
        }, f.$setPristine = function () {
            d.setClass(b, Qa, Fb + " ng-submitted"), f.$dirty = !1, f.$pristine = !0, f.$submitted = !1, r(g, function (a) {
                a.$setPristine()
            })
    ...
    function gb(b, a, c, d, e, f) {
        ...
        if (e.hasEvent("input"))a.on("input", m); else {
            ...
            a.on("keydown", function (a) {
                var b = a.keyCode;
                91 === b || b > 15 && 19 > b || b >= 37 && 40 >= b || s(a)
            }), e.hasEvent("paste") && a.on("paste cut", s)
        }
    ...
    function Gb(b, a) {
        return function (c, d) {
            ...
            if (I(c)) {
                ...
                if (b.lastIndex = 0, e = b.exec(c))return e.shift(), f = d ? {yyyy: d.getFullYear(), MM: d.getMonth() + 1, dd: d.getDate(), HH: d.getHours(), mm: d.getMinutes(), ss: d.getSeconds(), sss: d.getMilliseconds() / 1e3} : {yyyy: 1970, MM: 1, dd: 1, HH: 0, mm: 0, ss: 0, sss: 0}, r(e, function (b, c) {
                    c < a.length && (f[a[c]] = +b)
    ...
    function hb(b, a, c, d) {
        return function (e, f, g, h, k, l, m) {
            ...
            qd(e, f, g, h), gb(e, f, g, h, k, l);
            var q, t = h && h.$options && h.$options.timezone;
    ...
    function rd(b, a, c, d, e) {
        if (y(d)) {
            if (b = b(d), !b.constant)throw z("ngModel")("constexpr", c, d);
            return b(a)
        }
        return e
    }
    ...
    function pd(b) {
        ...
        function c(b, c) {
            b = b ? "-" + Mb(b, "-") : "", a(ib + b, !0 === c), a(sd + b, !1 === c)
        }

        var d = b.ctrl, e = b.$element, f = {}, g = b.set, h = b.unset, k = b.parentForm, l = b.$animate;
        f[sd] = !(f[ib] = e.hasClass(ib)), d.$setValidity = function (b, e, f) {
            e === u ? (d.$pending || (d.$pending = {}), g(d.$pending, b, f)) : (d.$pending && h(d.$pending, b, f), td(d.$pending) && (d.$pending = u)), Ua(e) ? e ? (h(d.$error, b, f), g(d.$$success, b, f)) : (g(d.$error, b, f), h(d.$$success, b, f)) : (h(d.$error, b, f), h(d.$$success, b, f)), d.$pending ? (a(ud, !0), d.$valid = d.$invalid = u, c("", null)) : (a(ud, !1), d.$valid = td(d.$error), d.$invalid = !d.$valid, c("", d.$valid)), e = d.$pending && d.$pending[b] ? u : d.$error[b] ? !1 : d.$$success[b] ? !0 : null, c(b, e), k.$setValidity(b, e, d)
        }
    }
    ...
    function ic(b, a) {
        return b = "ngClass" + b, ["$animate", function (c) {
            ...
            return{restrict: "AC", link: function (f, g, h) {
                    ...
                    if (!0 === a || f.$index % 2 === a) {
                        ...
                        if (m) {
                            if (!pa(b, m)) {
                                ...
                                t && t.length && c.addClass(g, t), l && l.length && c.removeClass(g, l)
                            }
                        } else {
                            var t = k(l, 1);
                            h.$addClass(t)
                ...
                var m;
                f.$watch(h[b], l, !0), h.$observe("class", function () {
                    l(f.$eval(h[b]))
    ...
    var Ha, A, qa, ab, Jf = /^\/(.+)\/([a-z]*)$/, R = function (b) {
        return I(b) ? b.toLowerCase() : b
    }, Jb = Object.prototype.hasOwnProperty, rb = function (b) {
        return I(b) ? b.toUpperCase() : b
    }, Ya = [].slice, of = [].splice, Kf = [].push, Ja = Object.prototype.toString, Wa = z("ng"), ha = U.angular || (U.angular = {}), kb = 0;
    Ha = V.documentMode, x.$inject = [], oa.$inject = [];
    var Nb, D = Array.isArray, P = function (b) {
        return I(b) ? b.trim() : b
    }, dd = function (b) {
    ...
    }, ob = ["ng-", "data-ng-", "ng:", "x-ng-"], Jd = /[A-Z]/g, sc = !1, na = 1, mb = 3, Nd = {full: "1.3.4", major: 1, minor: 3, dot: 4, codeName: "highfalutin-petroglyph"};
    S.expando = "ng339";
    var wb = S.cache = {}, df = 1;
    S._data = function (b) {
    ...
    r({data: Sb, removeData: ub}, function (b, a) {
        ...
        return a = bb(a), y(c) ? void(b.style[a] = c) : b.style[a]
    }, attr: function (b, a, c) {
        var d = R(a);
        if (yb[d]) {
            if (!y(c))return b[a] || (b.attributes.getNamedItem(a) || x).specified ? d : u;
        ...
        return G(a) ? b.innerHTML : (tb(b, !0), void(b.innerHTML = a))
    }, empty: Hc}, function (b, a) {
        S.prototype[a] = function (a, d) {
            var e, f, g = this.length;
            if (b !== Hc && (2 == b.length && b !== Tb && b !== Gc ? a : d) === u) {
                if (K(a)) {
                    for (e = 0; g > e; e++)if (b === Sb)b(this[e], a); else for (f in a)b(this[e], f, a[f]);
                    return this
                }
        ...
        if (Cc(c)) {
            ...
            for (var g = 0 <= d.indexOf(" ") ? d.split(" ") : [d], k = g.length; k--;) {
                ...
                }) : "$destroy" !== d && c.addEventListener(d, h, !1), l = f[d]), l.push(e)
            }
        }
        ...
        (h = (h = h && h.events) && h[g]) && (e = {preventDefault: function () {
        ...
        }, stopPropagation: x, type: g, target: a}, c.type && (e = C(e, c)), c = ua(h), f = d ? [e].concat(d) : [e], r(c, function (c) {
            e.isImmediatePropagationStopped() || c.apply(a, f)
        }))
    }}, function (a, c) {
        S.prototype[c] = function (c, e, f) {
            for (var g, h = 0, k = this.length; k > h; h++)G(g) ? (g = a(this[h], c, e, f), y(g) && (g = A(g))) : Ec(g, a(this[h], c, e, f));
            return y(g) ? g : this
    ...
    var Mf = z("$animate"), ze = ["$provide", function (a) {
        this.$$selectors = {}, this.register = function (c, d) {
            ...
            return{animate: function (a, c, d) {
                return l(a, {from: c, to: d}), k()
            }, enter: function (a, c, d, e) {
                return l(a, e), d ? d.after(a) : c.prepend(a), k()
            }, leave: function (a) {
                return a.remove(), k()
                ...
                return a = A(a), c = I(c) ? c : D(c) ? c.join(" ") : "", r(a, function (a) {
                    Vb(a, c)
                }), l(a, d), k()
                ...
                return m ? e && m.options && (m.options = ha.extend(m.options || {}, e)) : (m = {classes: {}, options: e}, l = !0), e = m.classes, c = D(c) ? c : c.split(" "), d = D(d) ? d : d.split(" "), h(e, c, !0), h(e, d, !1), l && (m.promise = f(function (c) {
                ...
                return c && this.$$addClassImmediately(a, c), d && this.$$removeClassImmediately(a, d), l(a, e), k()
            }, enabled: x, cancel: x}
        }]
    }], ka = z("$compile");
    ...
    var nf = /^((?:x|data)[\:\-_])/i, Sc = "application/json", Zb = {"Content-Type": Sc + ";charset=utf-8"}, qf = /^\s*(\[|\{[^\{])/, rf = /[\}\]]\s*$/, pf = /^\)\]\}',?\n/, $b = z("$interpolate"), Nf = /^([^\?#]*)(\?([^#]*))?(#(.*))?$/, uf = {http: 80, https: 443, ftp: 21}, eb = z("$location"), Of = {$$html5: !1, $$replace: !1, absUrl: Bb("$$absUrl"), url: function (a) {
        ...
        switch (arguments.length) {
            case 0:
                return this.$$search;
            case 1:
                if (I(a) || X(a))a = a.toString(), this.$$search = qc(a); else {
                    if (!K(a))throw eb("isrcharg");
    ...
    r([Zc, dc, cc], function (a) {
        a.prototype = Object.create(Of), a.prototype.state = function (c) {
            if (!arguments.length)return this.$$state;
            if (a !== cc || !this.$$html5)throw eb("nostate");
            return this.$$state = G(c) ? null : c, this
        }
    });
    ...
    r({"null": function () {
        ...
        a.constant = a.literal = a.sharedGetter = !0, Ib[c] = a
    }), Ib["this"] = function (a) {
        return a
    ...
    gc.prototype = {constructor: gc, lex: function (a) {
        ...
        for (var d = "", e = a, f = !1; this.index < this.text.length;) {
            ...
            if (f)"u" === g ? (f = this.text.substring(this.index + 1, this.index + 5), f.match(/[\da-f]{4}/i) || this.throwError("Invalid unicode escape [\\u" + f + "]"), this.index += 4, d += String.fromCharCode(parseInt(f, 16))) : d += Sf[g] || g, f = !1; else if ("\\" === g)f = !0; else {
                if (g === a)return this.index++, void this.tokens.push({index: c, text: e, constant: !0, value: d});
                d += g
            }
            this.index++
        }
    ...
    fb.ZERO = C(function () {
        return 0
    }, {sharedGetter: !0, constant: !0}), fb.prototype = {constructor: fb, parse: function (a) {
        ...
        return C(function (f, h) {
            var k = a(f, h);
            if (e) {
                for (e[0] = k, k = d.length; k--;)e[k + 1] = d[k](f, h);
                return c.apply(u, e)
            }
            return c(k)
        ...
        return(c = this.expect("&&")) && (a = this.binaryFn(a, c.text, this.logicalAND(), !0)), a
    }, equality: function () {
        var c, a = this.relational();
        return(c = this.expect("==", "!=", "===", "!==")) && (a = this.binaryFn(a, c.text, this.equality())), a
    }, relational: function () {
        var c, a = this.additive();
        return(c = this.expect("<", ">", "<=", ">=")) && (a = this.binaryFn(a, c.text, this.relational())), a
    }, additive: function () {
        ...
        return C(function (c, d, h) {
            ...
            return(h = a(e, h)) || a.assign(e, h = {}), Oa(h, d, g, c)
        }})
    }, objectIndex: function (a) {
        var c = this.text, d = this.expression();
        return this.consume("]"), C(function (e, f) {
            var g = a(e, f), h = d(e, f);
            return ra(h, c), g ? sa(g[h], c) : u
        }, {assign: function (e, f, g) {
            var h = ra(d(e, g), c);
            return(g = sa(a(e, g), c)) || a.assign(e, g = {}), g[h] = f
        }})
        ...
        return function (g, h) {
            ...
            return k = l.apply ? l.apply(k, f) : l(f[0], f[1], f[2], f[3], f[4]), sa(k, e)
        }
        ...
        return this.consume("]"), C(function (c, d) {
        ...
        return this.consume("}"), C(function (d, f) {
            for (var g = {}, h = 0, k = c.length; k > h; h++)g[a[h]] = c[h](d, f);
            return g
    ...
    Bc.$inject = ["$provide"], gd.$inject = ["$locale"], id.$inject = ["$locale"];
    var ld = ".", Hf = {yyyy: Z("FullYear", 4), yy: Z("FullYear", 2, 0, !0), y: Z("FullYear", 1), MMMM: Db("Month"), MMM: Db("Month", !0), MM: Z("Month", 2, 1), M: Z("Month", 1, 1), dd: Z("Date", 2), d: Z("Date", 1), HH: Z("Hours", 2), H: Z("Hours", 1), hh: Z("Hours", 2, -12), h: Z("Hours", 1, -12), mm: Z("Minutes", 2), m: Z("Minutes", 1), ss: Z("Seconds", 2), s: Z("Seconds", 1), sss: Z("Milliseconds", 3), EEEE: Db("Day"), EEE: Db("Day", !0), a: function (a, c) {
        ...
        return a = -1 * a.getTimezoneOffset(), a = (a >= 0 ? "+" : "") + (Cb(Math[a > 0 ? "floor" : "ceil"](a / 60), 2) + Cb(Math.abs(a % 60), 2))
    ...
    r(yb, function (a, c) {
        ...
        sb[c] = function () {
            return{priority: 100, link: function (a, e, f) {
                return"ngPattern" === c && "/" == f.ngPattern.charAt(0) && (e = f.ngPattern.match(Jf)) ? void f.$set("ngPattern", new RegExp(e[1], e[2])) : void a.$watch(f[c], function (a) {
                    f.$set(c, a)
                })
            }}
        }
        ...
        sb[c] = function () {
            return{priority: 99, link: function (d, e, f) {
                var g = a, h = a;
                "href" === a && "[object SVGAnimatedString]" === Ja.call(e.prop("href")) && (h = "xlinkHref", f.$attr[h] = "xlink:href", g = null), f.$observe(c, function (c) {
    ...
    var vd = function (a) {
        return["$timeout", function (c) {
            return{name: "form", restrict: a ? "EAC" : "E", controller: od, compile: function (a) {
                return a.addClass(Qa).addClass(ib), {pre: function (a, d, g, h) {
                    if (!("action"in g)) {
                        var k = function (c) {
                            a.$apply(function () {
                        ...
                        d[0].addEventListener("submit", k, !1), d.on("$destroy", function () {
                            c(function () {
        ...
        if (I(a)) {
            ...
            if (d) {
                ...
                return c && (d = c.getHours(), g = c.getMinutes(), h = c.getSeconds(), k = c.getMilliseconds()), new Date(e, 0, l.getDate() + f, d, g, h, k)
            }
        }
        return 0 / 0
    }, "yyyy-Www"), month: hb("month", yd, Gb(yd, ["yyyy", "MM"]), "yyyy-MM"), number: function (a, c, d, e, f, g) {
        if (qd(a, c, d, e), gb(a, c, d, e, f, g), e.$$parserName = "number", e.$parsers.push(function (a) {
            ...
            e.$validators.min = function (a) {
                ...
                y(a) && !X(a) && (a = parseFloat(a, 10)), h = X(a) && !isNaN(a) ? a : u, e.$validate()
            })
        }
        if (d.max || d.ngMax) {
            var k;
            e.$validators.max = function (a) {
                return e.$isEmpty(a) || G(k) || k >= a
            }, d.$observe("max", function (a) {
                y(a) && !X(a) && (a = parseFloat(a, 10)), k = X(a) && !isNaN(a) ? a : u, e.$validate()
            })
        }
    }, url: function (a, c, d, e, f, g) {
        gb(a, c, d, e, f, g), hc(e), e.$$parserName = "url", e.$validators.url = function (a, c) {
            var d = a || c;
            return e.$isEmpty(d) || Tf.test(d)
        }
    }, email: function (a, c, d, e, f, g) {
        gb(a, c, d, e, f, g), hc(e), e.$$parserName = "email", e.$validators.email = function (a, c) {
            var d = a || c;
            return e.$isEmpty(d) || Uf.test(d)
        }
    }, radio: function (a, c, d, e) {
        G(d.name) && c.attr("name", ++kb), c.on("click", function (a) {
        ...
        pd({ctrl: this, $element: e, set: function (a, c) {
            ...
            n.$dirty = !1, n.$pristine = !0, g.removeClass(e, Fb), g.addClass(e, Qa)
        }, this.$setDirty = function () {
            n.$dirty = !0, n.$pristine = !1, g.removeClass(e, Qa), g.addClass(e, Fb), v.$setDirty()
            ...
            h.cancel(N), n.$viewValue = n.$$lastCommittedViewValue, n.$render()
            ...
            function f() {
                ...
                return r(n.$validators, function (e, f) {
                    var g = e(c, d);
                    a = a && g, h(f, g)
                }), a ? !0 : (r(n.$asyncValidators, function (a, c) {
                    h(c, null)
                }), !1)
            }
            ...
            var a = n.$viewValue;
            h.cancel(N), (n.$$lastCommittedViewValue !== a || "" === a && n.$$hasNativeValidators) && (n.$$lastCommittedViewValue = a, n.$pristine && this.$setDirty(), this.$$parseAndValidate())
            ...
            n.$$rawModelValue = d, h && (n.$modelValue = d, n.$modelValue !== g && n.$$writeModelToScope()), n.$$runValidators(e, d, c, function (a) {
                h || (n.$modelValue = a ? d : u, n.$modelValue !== g && n.$$writeModelToScope())
            })
        }, this.$$writeModelToScope = function () {
            q(a, n.$modelValue), r(n.$viewChangeListeners, function (a) {
                try {
                    a()
                } catch (d) {
                    c(d)
            ...
            var d = 0, e = n.$options;
            e && y(e.debounce) && (e = e.debounce, X(e) ? d = e : X(e[c]) ? d = e[c] : X(e["default"]) && (d = e["default"])), h.cancel(N), d ? N = h(function () {
                n.$commitViewValue()
        ...
        return{restrict: "A", require: ["ngModel", "^?form", "^?ngModelOptions"], controller: Xf, priority: 1, compile: function (c) {
            return c.addClass(Qa).addClass("ng-untouched").addClass(ib), {pre: function (a, c, f, g) {
                var h = g[0], k = g[1] || Eb;
                h.$$setOptions(g[2] && g[2].$options), k.$addControl(h), f.$observe("name", function (a) {
        ...
        return{restrict: "A", require: "?ngModel", link: function (a, c, d, e) {
            if (e) {
                ...
                d.$observe("pattern", function (a) {
                    if (I(a) && 0 < a.length && (a = new RegExp("^" + a + "$")), a && !a.test)throw z("ngPattern")("noregexp", g, a, va(c));
                    f = a || u, e.$validate()
        ...
        return{restrict: "A", priority: 100, require: "ngModel", link: function (a, c, d, e) {
            ...
            e.$parsers.push(function (a) {
                if (!G(a)) {
                    var c = [];
                    return a && r(a.split(h), function (a) {
                        a && c.push(g ? P(a) : a)
                    }), c
                }
            }), e.$formatters.push(function (a) {
        ...
        return{restrict: "A", controller: ["$scope", "$attrs", function (a, c) {
            var d = this;
            this.$options = a.$eval(c.ngModelOptions), this.$options.updateOn !== u ? (this.$options.updateOnDefault = !1, this.$options.updateOn = P(this.$options.updateOn.replace(Wf, function () {
    ...
    var fe = ["$animate", function (a) {
        return{multiElement: !0, transclude: "element", priority: 600, terminal: !0, restrict: "A", $$tlb: !0, link: function (c, d, e, f, g) {
            ...
            c.$watch(e.ngIf, function (c) {
                c ? k || g(function (c, f) {
                    k = f, c[c.length++] = V.createComment(" end ngIf: " + e.ngIf + " "), h = {clone: c}, a.enter(c, d.parent(), d)
            ...
            return function (f, g, s, r, q) {
                ...
                f.$watch(e.parseAsResourceUrl(h), function (e) {
                    ...
                    e ? (a(e, !0).then(function (a) {
                        if (s === u) {
                            var c = f.$new();
                            r.template = a, a = q(c, function (a) {
                                O(), d.enter(a, null, g).then(h)
                            }), n = c, w = a, n.$emit("$includeContentLoaded", e), f.$eval(k)
                        }
                    }, function () {
        ...
        return{restrict: "EA", link: function (f, g, h) {
            ...
            var v, l = h.count, m = h.$attr.when && g.attr(h.$attr.when), p = h.offset || 0, s = f.$eval(m) || {}, t = {}, m = c.startSymbol(), q = c.endSymbol(), u = m + l + "-" + p + q, n = ha.noop;
            r(h, function (a, c) {
                var d = e.exec(c);
                ...
                c = parseFloat(c);
                var d = isNaN(c);
                d || c in s || (c = a.pluralCat(c - p)), c === v || d && isNaN(v) || (n(), n = f.$watch(t[c], k), v = c)
            })
        }}
    }], ke = ["$parse", "$animate", function (a, c) {
        var d = z("ngRepeat"), e = function (a, c, d, e, l, m, p) {
            a[d] = e, l && (a[l] = m), a.$index = c, a.$first = 0 === c, a.$last = c === p - 1, a.$middle = !(a.$first || a.$last), a.$odd = !(a.$even = 0 === (1 & c))
        };
        return{restrict: "A", multiElement: !0, transclude: "element", priority: 1e3, terminal: !0, $$tlb: !0, compile: function (f, g) {
            ...
            var n, v, w, z, E = {$id: Ma};
            return t ? n = a(t) : (w = function (a, c) {
                return Ma(c)
            }, z = function (a) {
                return a
            }), function (a, f, g, l, m) {
                n && (v = function (c, d, e) {
                    return y && (E[y] = c), E[q] = d, E.$index = e, n(a, E)
                });
                var t = ia();
                a.$watchCollection(p, function (g) {
                    var l, n, B, C, x, G, T, D, F, I, p = f[0], E = ia();
                    if (s && (a[s] = g), Ra(g))D = g, n = v || w; else {
                        n = v || z, D = [];
                        for (I in g)g.hasOwnProperty(I) && "$" != I.charAt(0) && D.push(I);
                        D.sort()
                    }
                    for (C = D.length, I = Array(C), l = 0; C > l; l++)if (x = g === D ? l : D[l], G = g[x], T = n(x, G, l), t[T])F = t[T], delete t[T], E[T] = F, I[l] = F; else {
                    ...
                    for (B in t) {
                        if (F = t[B], T = qb(F.clone), c.leave(T), T[0].parentNode)for (l = 0, n = T.length; n > l; l++)T[l].$$NG_REMOVED = !0;
                        F.scope.$destroy()
                    }
                    for (l = 0; C > l; l++)if (x = g === D ? l : D[l], G = g[x], F = I[l], F.scope) {
                        B = p;
                        do B = B.nextSibling; while (B && B.$$NG_REMOVED);
                        F.clone[0] != B && c.move(qb(F.clone), null, A(p)), p = F.clone[F.clone.length - 1], e(F.scope, l, q, G, y, x, C)
                    } else m(function (a, d) {
                        F.scope = d;
                        var f = k.cloneNode(!1);
                        a[a.length++] = f, c.enter(a, null, A(p)), p = f, F.clone = a, E[F.id] = F, e(F.scope, l, q, G, y, x, C)
                    });
                    t = E
                })
            }
        ...
        return{restrict: "EA", require: "ngSwitch", controller: ["$scope", function () {
            ...
            c.$watch(e.ngSwitch || e.on, function (c) {
                ...
                for (d = k.length = 0, e = l.length; e > d; ++d) {
                    var q = qb(h[d].clone);
                    l[d].$destroy(), (k[d] = a.leave(q)).then(m(k, d))
                }
                h.length = 0, l.length = 0, (g = f.cases["!" + c] || f.cases["?"]) && r(g, function (c) {
                    c.transclude(function (d, e) {
                        l.push(e);
                        var f = c.element;
                        d[d.length++] = V.createComment(" end ngSwitchWhen: "), h.push({clone: d}), a.enter(d, f.parent(), f)
                    })
                })
            })
        }}
    }], oe = Ia({transclude: "element", priority: 1200, require: "^ngSwitch", multiElement: !0, link: function (a, c, d, e, f) {
        ...
        return{restrict: "E", require: ["select", "?ngModel"], controller: ["$element", "$scope", "$attrs", function (a, c, d) {
            ...
            k.databound = d.ngModel, k.init = function (a, c, d) {
                ...
                La(c, '"option value"'), l[c] = !0, m.$viewValue == c && (a.val(c), p.parent() && p.remove()), d && d[0].hasAttribute("selected") && (d[0].selected = !0)
                ...
                c = "? " + Ma(c) + " ?", p.val(c), a.prepend(p), a.val(c), p.prop("selected", !0)
            ...
            function l(a, c, d, e) {
                d.$render = function () {
                    ...
                    a.$apply(function () {
                        E.parent() && E.remove(), d.$setViewValue(c.val())
                    })
                })
            }
            ...
            function p(e, f, g) {
                ...
                function k(a) {
                    ...
                    return function (d, e) {
                        var f;
                        return f = K ? K : C ? C : H, t ? y(c.remove(h(f, d, e))) : a === h(f, d, e)
                    }
                }
                ...
                function n() {
                    ...
                    var d, l, p, q, u, a = {"": []}, c = [""];
                    p = g.$viewValue, q = M(e) || [];
                    var x, A, H, D, C = G ? Object.keys(q).sort() : q, Q = {};
                    u = k(p);
                    var V, X, P = !1;
                    for (S = {}, D = 0; H = C.length, H > D; D++)x = D, G && (x = C[D], "$" === x.charAt(0)) || (A = q[x], d = h(I, x, A) || "", (l = a[d]) || (l = a[d] = [], c.push(d)), d = u(x, A), P = P || d, A = h(E, x, A), A = y(A) ? A : "", X = K ? K(e, U) : G ? C[D] : D, K && (S[X] = x), l.push({id: X, label: A, selected: d}));
                    for (t || (z || null === p ? a[""].unshift({id: "", label: "", selected: !P}) : P || a[""].unshift({id: "?", label: "", selected: !0})), x = 0, C = c.length; C > x; x++) {
                        for (d = c[x], l = a[d], R.length <= x ? (p = {element: F.clone().attr("label", d), label: l.label}, q = [p], R.push(q), f.append(p.element)) : (q = R[x], p = q[0], p.label != d && p.element.attr("label", p.label = d)), P = null, D = 0, H = l.length; H > D; D++)d = l[D], (u = q[D + 1]) ? (P = u.element, u.label !== d.label && (m(Q, u.label, !1), m(Q, d.label, !0), P.text(u.label = d.label), P.prop("label", u.label)), u.id !== d.id && P.val(u.id = d.id), P[0].selected !== d.selected && (P.prop("selected", u.selected = d.selected), Ha && P.prop("selected", u.selected))) : ("" === d.id && z ? V = z : (V = w.clone()).val(d.id).prop("selected", d.selected).attr("selected", d.selected).prop("label", d.label).text(d.label), q.push(u = {element: V, label: d.label, id: d.id, selected: d.selected}), m(Q, d.label, !0), P ? P.after(V) : p.element.append(V), P = V);
                        for (D++; q.length > D;)d = q.pop(), m(Q, d.label, !1), d.element.remove();
                        r(Q, function (a, c) {
                            a > 0 ? s.addOption(c) : 0 > a && s.removeOption(c)
                        })
                    }
                ...
                z && (a(z)(e), z.removeClass("ng-scope"), z.remove()), f.empty(), f.on("change", function () {
                    e.$apply(function () {
                        ...
                        if (t)c = [], r(f.val(), function (d) {
                            d = K ? S[d] : d, c.push("?" === d ? u : "" === d ? null : h(C ? C : H, d, a[d]))
                        }); else {
                ...
                }), g.$render = n, e.$watchCollection(M, l), e.$watchCollection(function () {
                    var c, a = M(e);
                    if (a && D(a)) {
                        c = Array(a.length);
                        for (var d = 0, f = a.length; f > d; d++)c[d] = h(E, d, a[d])
            ...
            if (k[1]) {
                var s = k[0];
                k = k[1];
                var n, t = h.multiple, q = h.ngOptions, z = !1, v = !1, w = A(V.createElement("option")), F = A(V.createElement("optgroup")), E = w.clone();
                h = 0;
                for (var x = g.children(), C = x.length; C > h; h++)if ("" === x[h].value) {
                    n = z = x.eq(h);
                    break
                }
                s.init(k, z, E), t && (k.$isEmpty = function (a) {
                    return!a || 0 === a.length
...
}(window, document), !window.angular.$$csp() && window.angular.element(document).find("head").prepend('<style type="text/css">@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\\:form{display:block;}</style>'), function (n, h, p) {
    "use strict";
    function E(a) {
        var d = [];
    ...
    h.module("ngSanitize", []).provider("$sanitize", function () {
        ...
        return function (e, b) {
            ...
            function f(a, c) {
                g.push("<a "), h.isDefined(b) && g.push('target="', b, '" '), g.push('href="', a.replace('"', "&quot;"), '">'), k(c), g.push("</a>")
            }

            if (!e)return e;
            for (var m, n, p, l = e, g = []; m = l.match(d);)n = m[0], m[2] == m[3] && (n = "mailto:" + n), p = m.index, k(l.substr(0, p)), f(n, m[0].replace(c, "")), l = l.substring(p + m[0].length);
            return k(l), a(g.join(""))
        }
    }])
}(window, window.angular), function (t, n) {
    ...
    var t = {audioCtx: window.AudioContext ? new AudioContext : null, defaults: {autoplay: !1, duration: 5e3, formats: [], loop: !1, placeholder: "--", preload: "metadata", volume: 80, webAudioApi: !1, document: window.document}, types: {mp3: "audio/mpeg", ogg: "audio/ogg", wav: "audio/wav", aac: "audio/aac", m4a: "audio/x-m4a"}, sounds: [], el: document.createElement("audio"), sound: function (n, e) {
        ...
        var e, i, u;
        return e = Math.floor(t / 3600), e = isNaN(e) ? "--" : e >= 10 ? e : "0" + e, i = Math.floor(n ? t / 60 % 60 : t / 60), i = isNaN(i) ? "--" : i >= 10 ? i : "0" + i, u = Math.floor(t % 60), u = isNaN(u) ? "--" : u >= 10 ? u : "0" + u, n ? e + ":" + i + ":" + u : i + ":" + u
...
Showdown.converter = function (a) {
    ...
    var w, k = function (a, b) {
        ...
        a = v(a);
        var b = A("<hr />");
        return a = a.replace(/^[ ]{0,2}([ ]?\*[ ]?){3,}[ \t]*$/gm, b), a = a.replace(/^[ ]{0,2}([ ]?\-[ ]?){3,}[ \t]*$/gm, b), a = a.replace(/^[ ]{0,2}([ ]?\_[ ]?){3,}[ \t]*$/gm, b), a = x(a), a = y(a), a = E(a), a = m(a), a = F(a)
    }, p = function (a) {
    ...
    var y = function (a) {
        ...
        return a = a.replace(/\t(?=\t)/g, "    "), a = a.replace(/\t/g, "~A~B"), a = a.replace(/~B(.+?)~A/g, function (a, b) {
            for (var d = b, e = 4 - d.length % 4, f = 0; e > f; f++)d += " ";
            return d
    ...
    return Showdown
}), angular.module("zenNodeWebkitModule", []).factory("fileDialog", [function () {
    var fs = require("fs"), callDialog = function (dialog, callback) {
        dialog.addEventListener("change", function () {
            callback(dialog.value)
        }, !1), dialog.click()
    }, dialogs = {};
    return dialogs.saveAs = function (callback, defaultFilename, acceptTypes) {
        var dialog = document.createElement("input");
        dialog.type = "file", dialog.nwsaveas = defaultFilename || "", angular.isArray(acceptTypes) ? dialog.accept = acceptTypes.join(",") : angular.isString(acceptTypes) && (dialog.accept = acceptTypes), callDialog(dialog, callback)
    }, dialogs.openFile = function (callback, multiple, acceptTypes) {
        var dialog = document.createElement("input");
        dialog.type = "file", multiple === !0 && (dialog.multiple = "multiple"), angular.isArray(acceptTypes) ? dialog.accept = acceptTypes.join(",") : angular.isString(acceptTypes) && (dialog.accept = acceptTypes), callDialog(dialog, callback)
    }, dialogs.openDir = function (callback) {
        var dialog = document.createElement("input");
        dialog.type = "file", dialog.nwdirectory = "nwdirectory", callDialog(dialog, callback)
        ...
        try {
            ...
            return console.log("File not found!"), !1
        }
        ...
        try {
            ...
            if ("ENOENT" !== e.code)throw e;
            return console.log("Directory not found!"), !1
        }
    }, dialogs
}]).factory("updateFactory", ["$rootScope", function ($rootScope) {
    return{runUpdate: function () {
        var pkg = require("./package.json"), updater = require("node-webkit-updater"), upd = new updater(pkg);
        upd.checkNewVersion(function (error, newVersionExists) {
            $rootScope.update_available = newVersionExists
        })
    }}
}]).run(function (updateFactory) {
    var gui = require("nw.gui");
    if (win = gui.Window.get(), "Mac" == os) {
        var nativeMenuBar = new gui.Menu({type: "menubar"});
        try {
            nativeMenuBar.createMacBuiltin("Zen Notebook"), win.menu = nativeMenuBar
        } catch (ex) {
        }
    }
    (os = "Windows") && (mute = !0), updateFactory.runUpdate()
}), angular.module("zenWebModule", []).factory("fileDialog", [function () {
    ...
    return dialogs.saveAs = function (callback, defaultFilename, acceptTypes) {
        ...
        var dialog = document.createElement("input");
        dialog.type = "file", dialog.nwdirectory = "nwdirectory", callDialog(dialog, callback)
    }, dialogs.writeFile = function () {
    }, dialogs.readFile = function () {
    }, dialogs
}]);
var os = "Unknown ";
-1 != navigator.appVersion.indexOf("Win") && (os = "Windows"), -1 != navigator.appVersion.indexOf("Mac") && (os = "Mac"), -1 != navigator.appVersion.indexOf("Linux") && (os = "Linux");
var isNodeWebkit = "object" == typeof process, platformModule = null, win;
platformModule = isNodeWebkit ? "zenNodeWebkitModule" : "zenWebModule";
var zenNotebook = angular.module("zenNotebook", ["ngSanitize", platformModule]).run(function ($rootScope, storageFactory) {
    $rootScope.mute = !1, storageFactory.getStorage("mute") && ($rootScope.mute = storageFactory.getStorage("mute")), $rootScope.active_component = storageFactory.getStorage("active_component"), $rootScope.active_component || ($rootScope.active_component = "notebook"), $rootScope.update_available = !1, $rootScope.version = null, $rootScope.latest_version = null
});
zenNotebook.filter("object2Array", function () {
    return function (input) {
        var out = [];
        for (i in input)out.push(input[i]);
        return out
    }
    ...
    ], menus = {message: null, menus: null, factory: null, loadComponent: function () {
        this.factory = $injector.get($rootScope.active_component + "Factory");
        var component_nav = this.factory.getMenu();
        this.menus = {nav: component_nav.concat(app_nav)}
    }, publishClick: function (message) {
        this.message = message, "left" == message.sub && $rootScope.$broadcast("toggleLeft"), "foot" == message.sub && $rootScope.$broadcast("toggleFoot"), "body" == message.sub && $rootScope.$broadcast("body"), "nw" == message.sub && ("maximize" == message.action && win.toggleFullscreen(), "minimize" == message.action && win.minimize(), "exit" == message.action && (this.factory.onExit(), win.close()))
    }, subscribeClick: function () {
        var message = this.message;
        return this.message = null, message
    }};
    return menus.loadComponent(), menus
}]), zenNotebook.factory("themeFactory", ["$rootScope", function () {
    return{theme: window.localStorage && window.localStorage.getItem("theme"), relaxSound: new buzz.sound("./assets/relax/rain.ogg", {loop: !0, volume: 80}), typeSounds: {spacebar: new buzz.sound("./assets/typewriter/spacebar.ogg", {volume: 60}), keyup: new buzz.sound("./assets/typewriter/keyup.ogg", {volume: 100}), bell: new buzz.sound("./assets/typewriter/bell.ogg", {volume: 100}), carriage_return_main: new buzz.sound("./assets/typewriter/carriage-return-main.ogg", {volume: 100}), carriage_return_stop: new buzz.sound("./assets/typewriter/carriage-return-stop.ogg", {volume: 100})}, typeSound: function (key_code) {
        "U+0051" == key_code ? sound = "spacebar" : "Alt" == key_code ? sound = "spacebar" : "CapsLock" == key_code ? sound = "spacebar" : "U+0020" == key_code ? sound = "spacebar" : "Enter" == key_code ? (sound = "carriage_return_main", sound = "carriage_return_stop") : sound = "U+0009" == key_code ? "bell" : "U+0008" == key_code ? "spacebar" : "Up" == key_code ? "spacebar" : "Down" == key_code ? "spacebar" : "Left" == key_code ? "spacebar" : "Right" == key_code ? "spacebar" : "keyup", this.typeSounds[sound].load(), this.typeSounds[sound].play()
    }, relaxStart: function () {
        this.relaxSound.load(), this.relaxSound.play()
    }, relaxStop: function () {
        this.relaxSound.stop()
    }, themeSound: function (event) {
        var theme = window.localStorage && window.localStorage.getItem("theme");
        event instanceof KeyboardEvent && ("typewriter light" == theme || "carbon dark" == theme) && this.typeSound(event.keyIdentifier), event instanceof FocusEvent && "relax dark" == theme ? this.relaxStart() : event instanceof FocusEvent && "relax dark" != theme && this.relaxStop()
    }}
}]), zenNotebook.factory("storageFactory", ["$rootScope", function () {
    return{getStorage: function (key, component) {
        return component && (key = component + "." + key), window.localStorage.getItem(key)
    }, setStorage: function (key, data, component) {
        component && (key = component + "." + key), window.localStorage.setItem(key, data)
    }, deleteStorage: function (key, component) {
        component && (key = component + "." + key), window.localStorage.removeItem(key)
    }}
}]), zenNotebook.factory("dropboxFactory", ["$rootScope", function () {
    return{}
}]), zenNotebook.factory("componentFactory", ["$rootScope", function () {
    return console.log(this), {factoryName: "null", documents: {}, onLoad: function () {
    }, onWrite: function () {
    }, onExit: function () {
    ...
    return{restrict: "A", link: function (scope, element) {
        ...
        }, 150), element.bind("blur keyup change focus", function (event) {
            scope.$apply(factory.onWrite(element.html())), 1 == $rootScope.mute && $injector.get("themeFactory").themeSound(event)
        }), $rootScope.$on("changeContent", function (event, content) {
            factory.onWrite(element.html()), element.html(content), factory.onWrite(element.html())
        }), $rootScope.$on("loadComponent", function () {
            factory = $injector.get($rootScope.active_component + "Factory"), element.html(factory.onLoad())
        })
    }}
}]), zenNotebook.controller("BodyController", ["$scope", "menuFactory", function ($scope, menuFactory) {
    $scope.themes = {zen_dark: "zen dark", zen_light: "zen light", terminal: "terminal courier", igcognito: "incognito", typewriter: "typewriter light", carbon: "carbon dark", relax: "relax dark"}, $scope.theme = window.localStorage && window.localStorage.getItem("theme"), $scope.theme || ($scope.theme = "zen dark"), $scope.count = 0, $scope.$on("body", function () {
        var nextCount, message = menuFactory.subscribeClick(), rowCount = 0;
        if (7 == $scope.count && ($scope.count = 0), nextCount = $scope.count + 1, "theme" == message.action)for (var key in $scope.themes)if (rowCount += 1, rowCount == nextCount)return $scope.theme = $scope.themes[key], window.localStorage && window.localStorage.setItem("theme", $scope.theme), void($scope.count = $scope.count + 1)
    })
}]), zenNotebook.controller("NavController", ["$scope", "menuFactory", function ($scope, menuFactory) {
    $scope.menu = menuFactory.menus.nav, $scope.expr = function (locals) {
    ...
    $scope.left = {}, $scope.$on("toggleLeft", function () {
        $scope.left.partial = "components/" + $rootScope.active_component + ".html", $scope.leftChangeClass = !$scope.leftChangeClass, $scope.expr = function (locals) {
            menuFactory.publishClick(locals)
        }
    })
    ...
    $scope.foot = {}, $scope.components = ["notebook", "nanowrimo", "leanpub"], $scope.$on("toggleFoot", function () {
        var message = menuFactory.subscribeClick();
        $scope.footChangeClass = !$scope.footChangeClass, $scope.foot.partial = "footer/" + message.action + ".html", $scope.expr = function (locals) {
            menuFactory.publishClick(locals)
        }, $scope.changeComponent = function (component) {
            $rootScope.active_component = component, storageFactory.setStorage("active_component", component), $rootScope.$broadcast("loadComponent"), window.location.reload()
        }
    })
    ...
    $scope.buttons = [
        ...
        for (var key in stats)$scope.left[key] = stats[key]
    }), $scope.expr = function (button) {
        "open" == button.action && fileDialog.openFile(function (filename) {
            notebookFactory.loadNotebook(filename)
        }, !1, ".json"), "save" == button.action && fileDialog.saveAs(function (filename) {
    ...
    return{restrict: "A", replace: !0, link: function (scope, element) {
        element.html(calendarFactory.getTemplate()), $compile(element.contents())(scope)
    }}
    ...
    return function (scope, element, attrs) {
        element.bind("click", function () {
            "set-date" == attrs.action && ($rootScope.$broadcast("changeContent", notebookFactory.onChangeDate(notebookFactory.activeDateText(), attrs.date)), notebookFactory.setActiveDate(attrs.date)), angular.element(document.getElementById("cal")).replaceWith($compile(calendarFactory.getTemplate(parseInt(attrs.month), parseInt(attrs.year), [parseInt(attrs.day)]))(scope))
        })
    }
}]), zenNotebook.factory("notebookFactory", ["$rootScope", "storageFactory", "fileDialog", function ($rootScope, storageFactory, fileDialog) {
    var notebook = {years: {}, file: null, currentDate: null, activeDate: null, activeDateText: function () {
        return this.activeYear + "-" + this.activeMonth + "-" + this.activeDay
    }, activeYear: null, activeMonth: null, activeDay: null, onLoad: function () {
        var file = storageFactory.getStorage("file");
        if (file) {
            this.loadNotebook(file), this.activeMonth = this.activeMonth + 1;
            var content = this.getDaysContent(this.activeDateText());
            storageFactory.setStorage("content", content)
        } else this.setActiveDate(this.currentDate);
        return this.getDaysContent(this.activeDateText())
    }, onWrite: function (content) {
        var count = this.countWords(content);
        storageFactory.setStorage("content", content), storageFactory.setStorage("word_count", count)
    }, onChangeDate: function (oldDate, newDate) {
        var old = oldDate.split("-");
        return this.setDaysContent(old[0] + "-" + old[1] + "-" + old[2]), this.getDaysContent(newDate) ? this.getDaysContent(newDate) : ""
    }, onExit: function () {
        var file = storageFactory.getStorage("file");
        file && (this.setDaysContent(this.activeDateText()), this.saveNotebook(file))
    }, getDaysContent: function (dateText) {
        var dates = dateText.split("-");
        try {
            return this.years[parseInt(dates[0])][parseInt(dates[1])][parseInt(dates[2])].content.replace(/\n/g, "<br>")
        } catch (err) {
            return storageFactory.setStorage("error", err), ""
        }
    }, setDaysContent: function (dateText) {
        this.getActiveContent().length > 0 && (dates = dateText.split("-"), this.years[parseInt(dates[0])][parseInt(dates[1])] || (this.years[parseInt(dates[0])][parseInt(dates[1])] = {}), this.years[parseInt(dates[0])][parseInt(dates[1])][parseInt(dates[2])] ? (this.years[parseInt(dates[0])][parseInt(dates[1])][parseInt(dates[2])].content = this.getActiveContent(), this.years[parseInt(dates[0])][parseInt(dates[1])][parseInt(dates[2])].word_count = this.countWords(this.getActiveContent())) : (this.years[parseInt(dates[0])][parseInt(dates[1])][parseInt(dates[2])] = {}, this.years[parseInt(dates[0])][parseInt(dates[1])][parseInt(dates[2])].content = this.getActiveContent(), this.years[parseInt(dates[0])][parseInt(dates[1])][parseInt(dates[2])].word_count = this.countWords(this.getActiveContent())))
    }, setActiveDate: function (rawDate) {
        var date;
        if (rawDate instanceof Date)date = rawDate; else {
            var dateList = rawDate.split("-");
            date = new Date(dateList[0], dateList[1], dateList[2])
        }
        this.activeDate = date, this.activeMonth = this.activeDate.getMonth(), this.activeYear = this.activeDate.getFullYear(), this.activeDay = this.activeDate.getDate(), this.years[this.activeYear] || (this.years[this.activeYear] = {}), this.years[this.activeYear][this.activeMonth] || (this.years[this.activeYear][this.activeMonth] = {}), this.years[this.activeYear][this.activeMonth][this.activeDay] || (this.years[this.activeYear][this.activeMonth][this.activeDay] = {})
    }, getActiveContent: function () {
        return storageFactory.getStorage("content").replace(/<br>/g, "\n").replace(/<div>/g, "\n").replace(/<\/div>/g, "")
    }, countWords: function (s) {
        return s = s.replace(/(^\s*)|(\s*$)/gi, ""), s = s.replace(/[ ]{2,}/gi, " "), s = s.replace(/\n /, "\n"), s.split(" ").length
        ...
        return{word_count: this.countWords(this.getActiveContent()), month_average: this.getMonthAverage(), month_count: this.getMonthCount()}
    }, getMenu: function () {
        return[
            {title: "Calendar", action: "calendar", "class": "fa fa-calendar", sub: "left"}
        ]
    }, activeTags: "", saveNotebook: function (filename) {
        var journal;
        this.file = filename, this.setDaysContent(this.activeDateText()), journal = JSON.stringify(this);
        try {
            return fileDialog.writeFile(filename, journal), storageFactory.setStorage("file", this.file), journal
        } catch (err) {
            storageFactory.setStorage("error", err), storageFactory.setStorage("recovery", journal)
        }
    }, loadNotebook: function (file) {
        var data = fileDialog.readFile(file);
        data ? (tempJournal = JSON.parse(data), this.file = file, this.currentDate = new Date, this.years = tempJournal.years, storageFactory.setStorage("file", this.file)) : storageFactory.deleteStorage("file")
    }};
    return notebook.currentDate || (notebook.currentDate = new Date), notebook.activeDate || notebook.setActiveDate(notebook.currentDate), notebook
}]), zenNotebook.factory("calendarFactory", ["$rootScope", "notebookFactory", function ($rootScope, notebookFactory) {
    return{monthNames: ["january", "february", "march", "april", "may", "june", "july", "august", "september", "october", "november", "december"], days: ["s", "m", "t", "w", "t", "f", "s"], daysInMonth: function (date) {
    ...
    }, currentDate: new Date, getTemplate: function (month, year, dates) {
        var month = (isNaN(month) || null == month ? this.currentDate.getMonth() + 1 : month) - 1, year = isNaN(year) || null == year ? this.currentDate.getFullYear() : year, firstDay = new Date(year, month, 1), startDay = firstDay.getDay(), monthLength = this.daysInMonth(firstDay), heading = this.formatDateHeading(firstDay), tpl = ['<div id="cal" class="cal">', '<table class="cal">', '<tr><th colspan="7">' + heading + "</th></tr>", "<tr>"], day = 1, rows = Math.ceil((monthLength + startDay) / 7);
        dates && dates.length || (dates = [this.currentDate.getDate()]), this.days.forEach(function (day) {
            tpl.push('<td class="cal-head">' + day.toUpperCase() + "</td>")
        }), tpl.push("</tr>");
        for (var i = 0; rows > i; i++) {
            for (var row = ["<tr>"], j = 0; 7 > j; j++) {
                if (row.push("<td>"), monthLength >= day && (i > 0 || j >= startDay)) {
                    var trueYear = year, nextYear = year, trueMonth = month + 1;
                    13 == trueMonth && (trueMonth = 1, trueYear = year + 1, nextYear = trueYear);
                    var nextMonth = trueMonth + 1;
                    13 == nextMonth && (nextMonth = 1, nextYear = year + 1);
                    var trueDate = year + "-" + trueMonth + "-" + day;
                    row.push(-1 == dates.indexOf(day) ? notebookFactory.getDaysContent(trueDate).length > 0 ? '<div class="cal-day cal-content" data-date="' + trueDate + '" data-month=' + trueMonth + " data-day=" + day + " data-year=" + year + ' data-action="set-date" changedate>' : '<div class="cal-day" data-date="' + trueDate + '" data-month=' + trueMonth + " data-day=" + day + " data-year=" + year + ' data-action="set-date" changedate>' : '<div class="cal-day cal-highlight" data-date="' + trueDate + '" data-month=' + trueMonth + " data-day=" + day + " data-year=" + year + ' data-action="set-date" changedate>'), row.push(day + "</div>"), day++
                }
                row.push("</td>")
            }
            row.push("</tr>"), tpl.push(row.join(""))
        }
        return tpl.push('</table><div class="navigation"><span class="fa fa-arrow-left" data-month=' + (trueMonth - 1) + " data-year=" + year + ' data-action="month-back" changedate></span><span class="today" data-month=' + trueMonth + " data-day=" + this.currentDate.getDate() + " data-year=" + year + ' data-action="set-date" changedate>Today</span><span class="fa fa-arrow-right" data-month=' + nextMonth + " data-year=" + nextYear + ' data-action="month-forward" changedate></span></div></div>'), tpl.join("")
    }}
    ...
    $scope.chapters = nanowrimoFactory.documents, $scope.buttons = [
        {title: "Open Book", "class": "open", action: "open"},
        {title: "Save Book", "class": "save", action: "save"}
    ], $scope.editedChapter = null, $scope.toggleChapter = function (chapter) {
        $scope.shownChapter = $scope.isChapterShown(chapter) ? null : chapter
        ...
        nanowrimoFactory.currentChapter = chapter, $scope.startEditing(chapter)
        ...
        $scope.setChapter(chapter), $scope.chapters[chapter].editing = !0, $scope.editedChapter = chapter
    }, $scope.doneEditing = function (oldChapter, newChapter) {
        nanowrimoFactory.editChapter(oldChapter, newChapter), $scope.editedChapter = null, $scope.chapters = nanowrimoFactory.documents
    }
}]), zenNotebook.factory("nanowrimoFactory", ["$rootScope", "storageFactory", "fileDialog", function ($rootScope, storageFactory, fileDialog) {
    return{documents: {}, file: null, title: null, currentChapter: null, startDate: null, goalDate: null, goalWords: null, currentDate: null, currentWords: null, chapterCount: function () {
        var count = 0;
        for (var k in this.documents)this.documents.hasOwnProperty(k) && ++count;
        return count
    }, onLoad: function () {
        var file = storageFactory.getStorage("file", "nanowrimo"), chapter = storageFactory.getStorage("chapter", "nanowrimo");
        return file && this.loadBook(file), chapter ? (this.currentChapter = chapter, this.getChapterContent(chapter)) : void 0
    }, onWrite: function (content) {
        var count = this.countWords(content);
        storageFactory.setStorage("content", content, "nanowrimo"), storageFactory.setStorage("word_count", count, "nanowrimo")
    }, onExit: function () {
        var file = storageFactory.getStorage("file", "nanowrimo");
        file && this.saveBook(file)
    }, createChapter: function () {
        var count = this.chapterCount() + 1, name = "Chapter " + count;
        return this.documents[name] = {name: name, old_name: name, editing: !1, content: "", sort_order: count, word_count: 0}, $rootScope.$broadcast("changeContent", this.onChangeChapter(this.currentChapter, name)), name
    }, editChapter: function (old_name, new_name) {
        old_name != new_name && (this.documents[new_name] = angular.copy(this.documents[old_name]), delete this.documents[old_name], this.documents[new_name].name = new_name, this.documents[new_name].old_name = new_name), this.documents[new_name].editing = !1
    }, setChapterContent: function (chapter) {
        if (this.getActiveContent().length > 0) {
            var content = this.getActiveContent();
            this.documents[chapter].content = content, this.documents[chapter].word_count = this.countWords(content)
        }
        this.currentChapter = chapter
    }, getChapterContent: function (chapter) {
        this.currentChapter = chapter;
        try {
            return this.documents[chapter].content.replace(/\n/g, "<br>")
        } catch (err) {
            return storageFactory.setStorage("error", err, "nanowrimo"), ""
        }
    }, onChangeChapter: function (oldChapter, newChapter) {
        return oldChapter && this.setChapterContent(oldChapter), this.getChapterContent(newChapter) ? this.getChapterContent(newChapter) : ""
    }, getActiveContent: function () {
        return storageFactory.getStorage("content", "nanowrimo").replace(/<br>/g, "\n").replace(/<div>/g, "\n").replace(/<\/div>/g, "")
    }, countWords: function (s) {
        return s = s.replace(/(^\s*)|(\s*$)/gi, ""), s = s.replace(/[ ]{2,}/gi, " "), s = s.replace(/\n /, "\n"), s.split(" ").length
    }, getSidebar: function () {
        return{word_count: this.countWords(this.getActiveContent())}
    }, getMenu: function () {
        return[
        ...
        var book;
        this.file = filename, this.setChapterContent(this.currentChapter), book = JSON.stringify(this);
        try {
            fileDialog.writeFile(filename, book), storageFactory.setStorage("file", this.file, "nanowrimo"), storageFactory.setStorage("chapter", this.currentChapter, "nanowrimo")
        } catch (err) {
            storageFactory.setStorage("error", err, "nanowrimo"), storageFactory.setStorage("recovery", book, "nanowrimo")
        }
    }, loadBook: function (file) {
        var data = fileDialog.readFile(file);
        data ? (tempBook = JSON.parse(data), this.file = file, storageFactory.setStorage("file", this.file, "nanowrimo"), this.documents = tempBook.documents) : storageFactory.deleteStorage("file", "nanowrimo")
    }}
    ...
    $scope.chapters = leanpubFactory.documents, $scope.buttons = [
        {title: "Open Book", "class": "open", action: "open"}
    ], $scope.editedChapter = null, $scope.toggleChapter = function (chapter) {
        $scope.shownChapter = $scope.isChapterShown(chapter) ? null : chapter
    }, $scope.isChapterShown = function (chapter) {
        ...
        "open" == button.action && fileDialog.openDir(function (dir) {
            leanpubFactory.loadBook(dir)
        }, !1, ".json")
    }, $scope.createChapter = function () {
        var chapter = leanpubFactory.createChapter();
        leanpubFactory.currentChapter = chapter, $scope.startEditing(chapter)
    }, $scope.setChapter = function (chapter) {
        $rootScope.$broadcast("changeContent", leanpubFactory.onChangeChapter(leanpubFactory.currentChapter, chapter))
    }, $scope.startEditing = function (chapter) {
        $scope.setChapter(chapter), $scope.chapters[chapter].editing = !0, $scope.editedChapter = chapter
    }, $scope.doneEditing = function (oldChapter, newChapter) {
        leanpubFactory.editChapter(oldChapter, newChapter), $scope.editedChapter = null, $scope.chapters = leanpubFactory.documents
    }
    ...
    return{documents: {}, file: null, title: null, currentChapter: null, startDate: null, goalDate: null, goalWords: null, currentDate: null, currentWords: null, chapterCount: function () {
        ...
        var file = storageFactory.getStorage("file", "leanpub"), chapter = storageFactory.getStorage("chapter", "leanpub");
        return file && this.loadBook(file), chapter ? (this.currentChapter = chapter, this.getChapterContent(chapter)) : void 0
    }, onWrite: function (content) {
        var count = this.countWords(content);
        storageFactory.setStorage("content", content, "leanpub"), storageFactory.setStorage("word_count", count, "leanpub")
    }, onExit: function () {
        ...
        try {
            ...
            return storageFactory.setStorage("error", err, "leanpub"), ""
        }
    }, onChangeChapter: function (oldChapter, newChapter) {
        return oldChapter && this.setChapterContent(oldChapter), this.getChapterContent(newChapter) ? this.getChapterContent(newChapter) : ""
    }, getActiveContent: function () {
        return storageFactory.getStorage("content", "leanpub").replace(/<br>/g, "\n").replace(/<div>/g, "\n").replace(/<\/div>/g, "")
    }, countWords: function (s) {
        return s = s.replace(/(^\s*)|(\s*$)/gi, ""), s = s.replace(/[ ]{2,}/gi, " "), s = s.replace(/\n /, "\n"), s.split(" ").length
    }, getSidebar: function () {
        return{word_count: this.countWords(this.getActiveContent())}
        ...
        for (var content, file, key, book = "", i = 0; i < this.documents.book.length; i++)book = book + this.documents.book[i] + "\n", key = this.documents.book[i].replace(".txt", ""), content = this.documents[key].content, file = this.file + this.documents.book[i], fileDialog.writeFile(file, content);
        fileDialog.writeFile(this.file + "Book.txt", book)
    }, loadBook: function (dir) {
        var book, data = fileDialog.readDir(dir), sort = 0;
        if (data)if (data.indexOf("manuscript") > -1) {
            this.file = dir + "/manuscript/", book = fileDialog.readFile(this.file + "Book.txt"), this.documents.book = book.split("\n");
            for (var i = 0; i < this.documents.book.length; i++) {
                var key = this.documents.book[i].replace(".txt", ""), content = fileDialog.readFile(this.file + this.documents.book[i]);
                this.documents[key] = {key: key, file: this.documents.book[i], title: key, content: content, word_count: this.countWords(content), sort_order: sort}, sort += 1
            }
            console.log(this.documents), storageFactory.setStorage("file", dir, "leanpub")
        } else storageFactory.deleteStorage("file", "leanpub"); else storageFactory.deleteStorage("file", "leanpub")
    }}
}]);