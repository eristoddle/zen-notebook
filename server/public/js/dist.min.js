...
zenNotebook.filter("object2Array", function () {
    ...
    return{documents: {}, file: null, title: null, currentChapter: null, startDate: null, goalDate: null, goalWords: null, currentDate: null, currentWords: null, chapterCount: function () {
        ...
        var book, frontmatter, backmatter, data = fileDialog.readDir(dir);
        data && data.indexOf("manuscript") > -1 ? (book = fileDialog.readFile(dir + "/manuscript/Book.txt"), this.documents.book = book.split("\n"), frontmatter = fileDialog.readFile(dir + "/manuscript/frontmatter.txt"), this.documents.frontmatter = frontmatter.split("\n"), backmatter = fileDialog.readFile(dir + "/manuscript/backmatter.txt"), this.documents.backmatter = backmatter.split("\n"), console.log(this.documents), this.file = dir, storageFactory.setStorage("file", dir, "leanpub")) : storageFactory.deleteStorage("file", "leanpub")
    }}
}]);