!function (U, V, u) {
    ...
    function uc(b, a) {
        ...
        this.debugInfoEnabled = function (a) {
            ...
            function G(a, b, c, d, e, f, g, h) {
                var l, s, k = [], p = b[0], n = a.shift(), w = C({}, n, {
                    templateUrl: null,
                    transclude: null,
                    replace: null,
                    $$originalDirective: n
    ...
    function He() {
        ...
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function (d, e, f, g, h, k) {
            ...
            function m(c, f, k) {
                ...
                function w(a, b, d, e) {
                    b = Math.max(b, 0), (b >= 200 && 300 > b ? E.resolve : E.reject)({
                        data: a,
                        status: b,
                        headers: Uc(d),
                        config: c,
                    ...
                    do {
                        ...
                        a:do {
                            if (m = L.$$watchers)for (t = m.length; t--;)try {
                                ...
                                } else v = !0, c = e, e.last = e.eq ? Ca(g, null) : g, e.fn(g, k === p ? g : k, L), 5 > r && (y = 4 - r, u[y] || (u[y] = []), u[y].push({
    ...
    function Aa(b) {
        return Ha && (Y.setAttribute("href", b), b = Y.href), Y.setAttribute("href", b), {
            href: Y.href,
    ...
    }, ob = ["ng-", "data-ng-", "ng:", "x-ng-"], Jd = /[A-Z]/g, sc = !1, na = 1, mb = 3, Nd = {
        full: "1.3.4",
        major: 1,
        minor: 3,
        dot: 4,
        ...
        this.$$selectors = {}, this.register = function (c, d) {
            ...
            return {
                animate: function (a, c, d) {
                    ...
                    return m ? e && m.options && (m.options = ha.extend(m.options || {}, e)) : (m = {
                        classes: {},
                        options: e
                    }, l = !0), e = m.classes, c = D(c) ? c : c.split(" "), d = D(d) ? d : d.split(" "), h(e, c, !0), h(e, d, !1), l && (m.promise = f(function (c) {
    ...
    var vd = function (a) {
        return ["$timeout", function (c) {
            return {
                name: "form", restrict: a ? "EAC" : "E", controller: od, compile: function (a) {
                    return a.addClass(Qa).addClass(ib), {
        ...
        return {
            ...
            priority: 1,
            compile: function (c) {
                return c.addClass(Qa).addClass("ng-untouched").addClass(ib), {
...
zenNotebook.filter("object2Array", function () {
    ...
    var app_nav = [{title: "Export", action: "export", "class": "fa fa-download", sub: "foot"}, {
        title: "Theme",
        action: "theme",
        "class": "fa fa-adjust",
        sub: "body"
        ...
        sub: "nw"
    }, {title: "Exit", action: "exit", "class": "fa fa-power-off", sub: "nw"}], menus = {
        message: null,
        menus: null,
        factory: null,
    ...
    return {
        ...
        relaxSound: new buzz.sound("./assets/relax/rain.ogg", {loop: !0, volume: 80}),
        typeSounds: {
    ...
    return console.log(this), {
        factoryName: "null", documents: {}, onLoad: function () {
        }, onWrite: function () {
        }, onExit: function () {
    ...
    $scope.themes = {
        ...
        carbon: "carbon dark",
        relax: "relax dark"
    }, $scope.theme = window.localStorage && window.localStorage.getItem("theme"), $scope.theme || ($scope.theme = "zen dark"), $scope.count = 0, $scope.$on("body", function () {
    ...
    $scope.buttons = [{title: "Open Notebook", "class": "open", action: "open"}, {
        title: "Save Notebook",
        "class": "save",
        action: "save"
    ...
    return {
        restrict: "A", replace: !0, link: function (scope, element) {
    ...
    var notebook = {
        years: {}, file: null, currentDate: null, activeDate: null, activeDateText: function () {
            ...
            return [{title: "Calendar", action: "calendar", "class": "fa fa-calendar", sub: "left"}]
    ...
    return {
        ...
        createChapter: function () {
            ...
            return this.documents[name] = {
                ...
                sort_order: count,
                word_count: 0
            }, $rootScope.$broadcast("changeContent", this.onChangeChapter(this.currentChapter, name)), name
        },
        ...
        getMenu: function () {
            return [{title: "NanoWrimo", action: "nanowrimo", "class": "fa fa-book", sub: "left"}]
        },
    ...
    return {
        ...
        getMenu: function () {
            return [{title: "leanpub", action: "leanpub", "class": "fa fa-book", sub: "left"}]
        },
        saveBook: function () {
