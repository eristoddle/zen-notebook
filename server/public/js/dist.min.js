...
zenNotebook.filter("object2Array", function () {
    ...
    return{documents: {}, file: null, title: null, currentChapter: null, startDate: null, goalDate: null, goalWords: null, currentDate: null, currentWords: null, chapterCount: function () {
        ...
        data && data.indexOf("manuscript") > -1 ? (this.file = dir + "/manuscript/", book = fileDialog.readFile(this.file + "Book.txt"), this.documents.book = book.split("\n"), console.log(this.documents), storageFactory.setStorage("book", this.documents.book, "leanpub"), storageFactory.setStorage("file", dir, "leanpub")) : storageFactory.deleteStorage("file", "leanpub")
    }}
}]);