...
}), zenNotebook.factory("accountFactory", ["$rootScope", function () {
    return {
        token: "", endpoint: "http://zen-notebook.local:8000/api/", notebooks: {}, postData: function () {
            $http.post(this.endpoint + "login", data).success(function (data) {
                console.log(data)
            }).error(function (data) {
