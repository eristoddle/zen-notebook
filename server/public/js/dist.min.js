...
var zenNotebook = angular.module("zenNotebook", ["ngSanitize", "ngDialog", platformModule]).run(function ($rootScope, storageFactory) {
...
zenNotebook.filter("object2Array", function () {
    ...
    $scope.themes = {
        ...
        carbon: "carbon dark",
        relax: "relax dark"
    }, $scope.components = ["notebook", "nanowrimo", "leanpub"], $scope.theme = window.localStorage && window.localStorage.getItem("theme"), $scope.theme || ($scope.theme = "zen dark"), $scope.count = 0, $scope.$on("body", function () {
        ...
        "login" == message.action && ngDialog.open({template: "partials/zen_login.html"}), "open_remote" == message.action && ngDialog.open({template: "partials/zen_user.html"}), ngDialog.open({template: "partials/" + message.action + ".html"}), $scope.expr = function (locals) {
