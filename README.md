...
This readme is too long and the rest may not be applicable any more. Switched to using Expo and Electron based on this post: https://dev.to/evanbacon/making-desktop-apps-with-electron-react-native-and-expo-5e36
