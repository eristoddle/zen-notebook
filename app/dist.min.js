...
zenNotebook.filter("object2Array", function () {
    ...
    return {
        ...
        login: function (email, pass) {
            return storageFactory.setStorage("zen_notebook_token", null), $http.post(this.endpoint + "attempt", {
                email: email,
                password: pass
            }).then(function (response) {
                return response.data.token && (this.message = "Logged In", storageFactory.setStorage("zen_notebook_email", email), storageFactory.setStorage("zen_notebook_token", response.data.token), this.token = response.data.token), response.data
            })
        },
        checkLogin: function () {
            return this.token ? $http.get(this.endpoint + "auth?token=" + this.token).then(function (response) {
                return response
            }) : !1
        },
        getNotebooks: function () {
            return $http({
                ...
                return this.notebooks = response.data.data, response
            })
        },
    ...
    var app_nav = [{title: "Theme", action: "theme", "class": "fa fa-adjust", sub: "body"}, {
        ...
        message: null, menus: null, factory: null, loadComponent: function () {
    ...
    $scope.account = {
        ...
        console.log(res.data), $scope.account.notebooks = accountFactory.notebooks
    })
