...
zenNotebook.filter("object2Array", function () {
    ...
    return {
        token: "", endpoint: "http://zen-notebook.local:8000/api/", notebooks: {}, login: function (email, pass) {
    ...
    $scope.components = ["notebook", "nanowrimo", "leanpub"], $scope.changeComponent = function (component) {
        ...
        storageFactory.setStorage("zen_notebook_token", null), accountFactory.login(user.email, user.password).then(function (d) {
            $scope.message = d.message, d.token && storageFactory.setStorage("zen_notebook_token", d.token)
        })
